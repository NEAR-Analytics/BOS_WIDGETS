...
const openTrove = async () => {
  ...
  // const NICR = null;
  // 이 계산 식을 적용하는 이유...
  // NICR = ETHColl * 1e20 / expectedDebt
 ...
 *
 * * 이 코드 블록은 시나리오를 초기화합니다.
 * 체크리스트는 귀하가 이미 지갑을 연결했다고 가정합니다.
 * 체크리스트
 * 1. 네트워크는 이더리움 메인넷이어야 합니다.
 * 2. 지갑에 ETH 잔액을 확보하세요.
 * 3. 보물이 이미 열려 있는지 확인하세요.
 * 4. 유동성 시스템 LUSD_GAS_COMPENSATION을 가져옵니다.
 * 5. 유동성 시스템 차입율을 구합니다.
 * 6. ETH:USD 가격을 확인하세요.
 * 7. TCR(총담보비율)이라는 유동성 시스템을 확보하세요.
 * 8. 유동성 확보 시스템은 복구 모드입니다.
 */
if (Ethers.provider()) {
