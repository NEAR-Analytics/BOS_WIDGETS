...
const { BuilderHat } = VM.require("builddao.near/widget/Icons") || {
  BuilderHat: () => <></>,
};
const GrowBG1 =
...
const ContributeImage1 = styled.img`
  ...
  right: 0;
  top: -34px;
  animation: slideInTranslate 2s forwards, scaleIn 1.5s forwards;
...
const ContributeImage2 = styled.img`
  ...
  right: 0;
  top: -180px;
  animation: slideInTranslate2 2s forwards, scaleIn2 1s forwards;
    ...
    <HeroContainer>
      <HeadingSection>
        <div className="row gap-3 flex-wrap">
          ...
          <Widget src="builddao.near/widget/page.home.hero.Vertical" />
        </div>
        <Subheading>
        ...
        <div className="d-flex align-items-center gap-4 hero-btns">
          <Button
            ...
            href={`${
              context.account
                ? "${config_index}?page=projects"
                : "https://nearbuilders.org/join"
            }`}
          >
            Start Project
          </Button>
      ...
      <CardSection>
        <Card>
          <ExploreContainer className="card-content d-flex flex-column gap-2">
            ...
            <Widget src="builddao.near/widget/page.home.hero.SocialGraph" />
          </ExploreContainer>
        </Card>
        <CenterCard>
          <div className="d-flex flex-column gap-2 rounded-4 overflow-hidden opacity-50">
            <Widget
              src="builddao.near/widget/page.home.hero.ScrollingText"
              props={{
                direction: "normal",
                words: [
                  "Funding Program",
        ...
        <EndCard>
          <GrowContainer className="card-content">
            ...
            {/* <Button variant="primary" href="builddao.near/widget/Index?page=activity">
              Activity
            </Button> */}
          </GrowContainer>
