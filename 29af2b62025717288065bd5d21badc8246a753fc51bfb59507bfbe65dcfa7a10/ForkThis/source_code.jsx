...
return (
  <Wrapper>
    <Header>
      <Widget src="hack.near/widget/Create.Page" />
      <h3>All Tutorials</h3>
      <Text>
    ...
    <Items>
      <Item>
        <Widget
          ...
          props={{ src: "hack.near/widget/bos.Page" }}
        />
      </Item>
      <Item>
        <Widget
          src="adminalpha.near/widget/ComponentCard"
          props={{ src: "hack.near/widget/abc.Page" }}
        />
      </Item>
      <Item>
        <Widget
          src="adminalpha.near/widget/ComponentCard"
          props={{ src: "evrything-docs.near/widget/hackathon.Page" }}
        />
      </Item>
    </Items>
  </Wrapper>
