...
const title = props.title ?? "cual es tu nombre?";
const receiver = props.receiver ?? "forestkeeperio.near";
...
let description = props.description ?? "Mi primer NFT, increible widget!";
...
const handleMint = () => {
  ...
  if (!accountId) {
    ...
    console.log("Cual es el titulo de tu NFT");
    State.update({
      showAlert: true,
      toastMessage: "Ingresa el nombre de tu NFT",
    });
    ...
    State.update({
      showAlert: true,
      toastMessage: "Ingresa la descripcion de tu NFT",
    });
    setTimeout(() => {
      State.update({
        showAlert: false,
