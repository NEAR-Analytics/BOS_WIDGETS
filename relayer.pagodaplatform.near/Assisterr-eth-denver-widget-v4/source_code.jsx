        ...
        <div>
          ...
          <Overview>
            <div className="row">
              ...
              <div className="col-7">
                <Prompt>
                  <Label>Prompt:</Label> The Code Helper AI is an advanced model
                  fine-tuned on Stack Overflow, designed to assist developers in
                  navigating and resolving coding challenges with ease and
                  efficiency. This AI understands a wide range of
                  programming-related queries and provides personalized
                  solutions that align with the developer's coding style,
                  language preferences, and project requirements.
                </Prompt>
              </div>
            </div>
          </Overview>
