...
const nftCollectionABI = [
  {
    inputs: [
      { internalType: "address", name: "_withdrawTarget", type: "address" },
      { internalType: "address", name: "_royaltyReceiver", type: "address" },
      { internalType: "uint96", name: "_royaltyNumerator", type: "uint96" },
    ],
  ...
  },
  {
    ...
    name: "mintedDuringAllowlistSale",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_allowlist", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "_newWithdrawTarget", type: "address" },
    ],
