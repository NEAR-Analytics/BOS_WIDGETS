const { Tile } =
  VM.require("devgovgigs.near/widget/devhub.components.molecule.Tile") ||
  (() => <></>);
...
return (
  ...
  >
    <Tile>
      <Widget
        src={
          "devgovgigs.near/widget/devhub.entity.community.configuration.BrandingConfigurator"
        }
        props={{
          onSubmit: sectionSubmit,
          data: communityData,
          hasConfigurePermissions,
          link: `/devgovgigs.near/widget/app?page=community&handle=${handle}`,
        }}
      />
    </Tile>
    <Tile className={"p-3"}>
      <Widget
        src={
          "devgovgigs.near/widget/devhub.entity.community.configuration.ConfigurationSection"
        }
        props={{
          ...
          Configurator: (p) => (
            <Widget
              src={
                "devgovgigs.near/widget/devhub.entity.community.configuration.InformationConfigurator"
              }
              props={{
                data: communityData,
                onSubmit: sectionSubmit,
      ...
      <Widget
        ...
        props={{
          ...
          Configurator: (p) => (
            <Widget
              src={
                "devgovgigs.near/widget/devhub.entity.community.configuration.AboutConfigurator"
              }
              props={{
                data: communityData,
                onSubmit: sectionSubmit,
      ...
      <Widget
        ...
        props={{
          ...
          Configurator: (p) => (
            <Widget
              src={
                "devgovgigs.near/widget/devhub.entity.community.configuration.AccessControlConfigurator"
              }
              props={{
                data: communityData,
                onSubmit: sectionSubmit,
        ...
        <Widget
          ...
          props={{
            ...
            Configurator: (p) => (
              <Widget
                src={
                  "devgovgigs.near/widget/devhub.entity.community.configuration.AddonsConfigurator"
                }
                props={{
