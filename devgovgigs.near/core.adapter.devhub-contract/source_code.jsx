  ...
  return [
    {
      ...
      view_widget: "devgovgigs.near/widget/devhub.entity.addon.wiki.Viewer",
      configurator_widget:
        "devgovgigs.near/widget/devhub.entity.addon.wiki.Configurator",
    },
    {
      id: "telegram",
      title: "Telegram",
      description: "Connect your telegram",
      view_widget: "devgovgigs.near/widget/devhub.entity.addon.telegram.Viewer",
      configurator_widget:
        "devgovgigs.near/widget/devhub.entity.addon.telegram.Configurator",
    },
    // {
    //   id: "github",
    //   title: "Github",
    //   description: "Connect your github",
    //   view_widget: "devgovgigs.near/widget/devhub.entity.addon.github.Viewer",
    //   configurator_widget:
    //     "devgovgigs.near/widget/devhub.entity.addon.github.Configurator",
    // },
    // {
    //   id: "kanban",
    //   title: "Kanban",
    //   description: "Connect your github kanban board",
    //   view_widget: "devgovgigs.near/widget/devhub.entity.addon.kanban.Viewer",
    //   configurator_widget:
    //     "devgovgigs.near/widget/devhub.entity.addon.kanban.Configurator",
    // },
    {
      id: "blog",
      title: "Blog",
      description: "Create a blog for your community",
      view_widget: "devgovgigs.near/widget/devhub.entity.addon.blog.Viewer",
      configurator_widget:
