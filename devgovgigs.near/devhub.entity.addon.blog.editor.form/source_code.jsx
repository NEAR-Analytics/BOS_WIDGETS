  ...
  return (
    <div>
      ...
      <div className="flex-grow-1">
        <Widget
          src="devgovgigs.near/widget/devhub.components.molecule.Input"
          props={{
...
const CategorySelect = ({ options, category, setCategory }) => {
  return (
    <div>
      ...
      <div className="flex-grow-1">
        <Widget
          src={"devgovgigs.near/widget/devhub.components.molecule.Select"}
          props={{
            className: "flex-grow-1",
            options,
            value: category,
...
const ContentEditor = ({ content, setContent }) => {
  return (
    <div>
      <h5>Content</h5>
      <Widget
        src="devgovgigs.near/widget/devhub.components.molecule.MarkdownEditor"
