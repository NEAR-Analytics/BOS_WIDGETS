...
const tabs = [
  {
    title: "Activity",
    view: "devgovgigs.near/widget/devhub.entity.community.Activity",
    params: {
  ...
  {
    title: "Teams",
    view: "devgovgigs.near/widget/devhub.entity.community.Teams",
    params: {
      handle: community.handle,
    },
  },
...
(community.addons || []).map((addon) => {
  addon.enabled &&
    tabs.push({
      ...
      view: "devgovgigs.near/widget/devhub.page.addon",
      params: { addon },
    });
});
    ...
    <div className="container d-flex flex-wrap justify-content-between align-items-center align-items-md-start gap-4">
      ...
      <div className="d-flex align-items-end gap-3 ms-auto mb-md-5">
        {permissions.can_configure && (
          <Link
            to={`/devgovgigs.near/widget/app?page=community.configuration&handle=${community.handle}`}
          >
            <Widget
      ...
      {currentTab.title === "Activity" && (
        ...
        >
          ...
          {context.accountId && (
            <Widget
              src={
                "devgovgigs.near/widget/devhub.components.molecule.PostControls"
              }
              props={{
                title: "Post",
                href: href({
