...
const renderItem = (item) => {
  return (
    <Widget
      src="roshaan.near/widget/ModelMarketplace.Model.ModelCard"
      props={{
...
const createWidget = "roshaan.near/widget/ModelMarketplace.Model.AgentCreate";
const description = "LineageAI Marketplace";
...
return (
  <div>
    <Widget src="roshaan.near/widget/ModelMarketplace.Model.AgentHeader" props={{ text: description, color: "#11181c" }} />
    <Items>
