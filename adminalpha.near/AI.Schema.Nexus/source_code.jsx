        ...
        content: (
          <Widget
            ...
            props={{
              ...
              schemaFile: "near/widget/AI.Schema.AlignmentDataset",
            }}
          />
        ),
        icon: "ph ph-chart-bar-horizontal",
        ...
        content: (
          <Widget
            ...
            props={{
              ...
              schemaFile: "near/widget/AI.Schema.Provider",
            }}
          />
        ),
        icon: "ph ph-chart-bar-horizontal",
        ...
        content: (
          <Widget
            ...
            props={{
              ...
              schemaFile: "near/widget/AI.Schema.ModelName",
            }}
          />
        ),
        icon: "ph ph-chart-bar-horizontal",
    ...
    items: [
      {
        ...
        value: "agents",
        content: (
          <Widget src="near/widget/AI.Agent.AgentEntityConfig" />
        ),
