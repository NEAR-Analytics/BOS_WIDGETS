...
const Mainnet = [
  {
    title: "Crypto Heroes",
    url: "https://pd.marmaj.org/cryptoheroes",
  },
];
const Testnet = [
  {
    title: "Crypto Heroes",
    url: "https://pd-testnet.marmaj.org/cryptoheroes",
  },
];
const Wiki = [
  {
  ...
  >
    <Hero>
      ...
      <p style={{ marginBottom: "20px", width: "100%", textAlign: "justify" }}>
        Cryptoheroes is a game that will be familiar to people who have played
        WoW: PVE gameplay — looting, selling and crafting items, fighting
        friends against dungeon bosses.
      </p>
    ...
    <Widget src="quan15.near/widget/carousel" props={slide_data} />
    <CardList>
