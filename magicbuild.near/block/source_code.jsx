...
const getPrompt = () => {
  ...
  asyncFetch("https://api.openai.com/v1/chat/completions", {
      ...
      messages: [
        {
          role: "user",
          content:
            "Act as a UI developer, users will fill out a prompt about their frontend ideas, and your role is to create a css style animation of the Button , Label , Sidebar , Card , Form , Accordion , Pagination. Create button effects, Button , Label , Sidebar , Nav, Form , Spiner Button , Loading , Tab , Header , Footer font size 30. User prompt:{" +
            state.prompt +
            "}. Give me the JSON for an object : {HTML:`Code`, CSS: `Code`} and without explaination",
        },
      ],
      max_tokens: 1000,
      temperature: 1,
    ...
    headers: {
      ...
      Authorization: `Bearer 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`,
    },
    method: "POST",
  }).then((res) => {
    if (
