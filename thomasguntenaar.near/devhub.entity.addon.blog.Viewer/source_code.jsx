const { Card } =
  VM.require("previewthomas.near/widget/devhub.entity.addon.blog.Card") ||
  (() => <></>);
...
function BlogCard(postId) {
  return (
    <Link
      ...
      to={href({
        widgetSrc: "previewthomas.near/widget/dh.blog",
        params: { id: postId },
      })}
    >
      <CardContainer>
        <Widget // We need this so the individual posts can make the necessary call for more data
          src="previewthomas.near/widget/devhub.entity.post.Postv2"
...
return (
  <div class="w-100">
    ...
    <Widget
      src={"previewthomas.near/widget/devhub.entity.addon.blog.Feed"}
