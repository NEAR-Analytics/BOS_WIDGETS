...
if (!proposal) {
  return (
    ...
    >
      <Widget
        src={"thomasguntenaar.near/widget/devhub.components.molecule.Spinner"}
      />
    </div>
  );
}
...
const proposalURL = `https://near.org/thomasguntenaar.near/widget/app?page=proposal&id=${proposal.id}&timestamp=${snapshot.timestamp}`;
...
return (
  <Container className="d-flex flex-column gap-2 w-100 mt-4">
    <Widget
      src={"thomasguntenaar.near/widget/devhub.entity.proposal.ConfirmReviewModal"}
      props={{
    ...
    />
    <Widget
      src={"thomasguntenaar.near/widget/devhub.entity.proposal.ConfirmCancelModal"}
      props={{
          ...
          <div className="d-flex flex-wrap gap-6">
            ...
            >
                ...
                <ProposalContainer className="rounded-2 flex-1">
                  ...
                  <div className="d-flex flex-column gap-1 p-2 px-3 description-box">
                    ...
                    <div className="d-flex gap-2 align-items-center mt-4">
                      ...
                      <Widget
                        src={
                          "thomasguntenaar.near/widget/devhub.entity.proposal.CommentIcon"
                        }
                        props={{
                          item,
                          showOverlay: false,
              ...
              <div className="border-bottom pb-4 mt-4">
                <Widget
                  src={
                    "thomasguntenaar.near/widget/devhub.entity.proposal.CommentsAndLogs"
                  }
                  props={{
                    ...props,
                    id: proposal.id,
              ...
              >
                <Widget
                  src={
                    "thomasguntenaar.near/widget/devhub.entity.proposal.ComposeComment"
                  }
                  props={{
                    ...props,
                    item: item,
            ...
            >
              ...
              <SidePanelItem title="Recipient Verification Status">
                <Widget
                  src="thomasguntenaar.near/widget/devhub.entity.proposal.VerificationStatus"
                  props={{
