        ...
        <div className="d-flex gap-4 w-100">
          ...
          <div className="d-flex flex-column gap-2 w-100 text-wrap">
            ...
            <div className="d-flex gap-2 align-items-center">
              ...
              <Widget
                src={"thomasguntenaar.near/widget/devhub.entity.proposal.CommentIcon"}
                props={{
                  item,
                  showOverlay: false,
                  onClick: () => {},
    ...
    <Container className="w-100 py-4 px-2 d-flex flex-column gap-3">
      <div className="d-flex justify-content-between flex-wrap gap-2 align-items-center">
        ...
        <div className="d-flex flex-wrap gap-4 align-items-center">
          <Widget
            src={
              "thomasguntenaar.near/widget/devhub.feature.proposal-search.by-input"
            }
            props={{
              search: state.input,
              className: "w-xs-100",
          ...
          />
          <Widget
            src={"thomasguntenaar.near/widget/devhub.feature.proposal-search.by-sort"}
            props={{
          ...
          <div className="d-flex gap-4 align-items-center">
            <Widget
              src={
                "thomasguntenaar.near/widget/devhub.feature.proposal-search.by-category"
              }
              props={{
                onStateChange: (select) => {
            ...
            <Widget
              src={
                "thomasguntenaar.near/widget/devhub.feature.proposal-search.by-stage"
              }
              props={{
                onStateChange: (select) => {
            ...
            <Widget
              src={
                "thomasguntenaar.near/widget/devhub.feature.proposal-search.by-author"
              }
              props={{
