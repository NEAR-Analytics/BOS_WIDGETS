...
const profileId = props.profileId ?? "everettbu.near";
const role = props.role ?? "Collaborators";
  ...
  <Wrapper>
    <Container>
      <Flex>
        ...
        <div className="mt-3">
          <Text style={{ maxWidth: "350px" }}>Project Comming Soon</Text>
        </div>
        {context.accountId && (
          <div className="m-3" style={{ maxWidth: "75%" }}>
            <Widget
              src="near/widget/AccountProfileCard"
              props={{ accountId: profileId }}
            />
          </div>
        )}
      </Flex>
