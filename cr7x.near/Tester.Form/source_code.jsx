  ...
  <Container>
    ...
    <Form>
      ...
      <Widget
        ...
        props={{
          label: "The NEAR Account of the Tester profile *",
          placeholder:
            "Enter the NEAR account ID of your Tester (wallet address like crowdtestify.near)",
              ...
              const transactions = [
                {
                  ...
                  args: { account_id: state.accountId, skills: state.skills },
                },
              ];
