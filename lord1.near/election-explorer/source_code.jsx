...
const generaltheme = {
  height: "110px",
  align: "center",
  description: "Explore the status of your Election activity.",
  brand: "Election Explorer",
  fontsize: "100",
  fontweight: "25px",
  afterbrand: "🏦",
...
const queryHashes = [
  ...
  { id: 2, hash: "96696597-7797-4096-9fe1-5dcbbe6a2c9c" },
  { id: 3, hash: "165e341e-4efc-4ef9-a7ae-035d7886a26d" },
  { id: 4, hash: "c7a65d89-6b47-44b2-b0d5-b080594e3af5" },
  { id: 5, hash: "ee065234-4fea-4c86-98a8-294238a86b04" },
  { id: 6, hash: "c4adb585-7c33-4b2d-bd40-b80c48d8bddd" },
  { id: 7, hash: "9f437c75-90b2-4b4b-b49b-895aca709c41" },
  { id: 8, hash: "0857676d-6450-4431-9695-bbd5ddb2251e" },
          ...
          props={{
            ...
            columns: [
...

              {
                ...
                progress: "yes",
                percent: "hidden",
                description: "House of Merit votes",
              },
              {
                title: "COA",
                key: "coa",
                progress: "yes",
                percent: "hidden",
                description: "Council Of Advisors votes",
              },
              {
                title: "TC",
                key: "tc",
              ...
              },
              {
                title: "BP",
                key: "VOTE",
                description: "Budget Package vote",
              },
            ],
          }}
        />
      ...
      <div className="row">
        ...
        <div className="col-md-4">
          ...
          <div
            ...
            className="w-100 mx-auto shadow-sm rounded-4 overflow-auto"
          >
            {state.ninthfilteredData.length > 0 ? (
              <Widget
                src="lord1.near/widget/table-pagination"
                props={{
                  themeColor: {
      ...
      {!state.isLoading && state.data && (
        ...
        >
          ...
          <div>
            ...
            {state.tab === "first" && (
              <Widget
                src="lord1.near/widget/first-tab-explore-election"
                props={{
            ...
            {state.tab === "second" && (
              <Widget
                src="lord1.near/widget/second-tab-explore-election"
                props={{
