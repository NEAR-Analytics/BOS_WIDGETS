...
const singer = props.singer; //0xc4ed448e7d7bdd954e943954459017be63584f69
...
SELECT  
    ...
    FROM base.core.fact_transactions 
            inner JOIN  base.core.dim_labels
...
const hellosinger = {
  ...
  fontweight: "25px",
  afterbrand: `${
    onHandelId(state.result.query4?.data[0]?.signer) || "Base man"
  }`,
  afterbrandcolor: themeColor?.dynamic_header?.afterbrandcolor || "#789efb",
  fontbrand: " Arial, sans-serif",
  color1brand: themeColor?.dynamic_header?.color1brand || "#000",
