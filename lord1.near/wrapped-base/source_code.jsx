const darkColors = {
  ...
  footer: {
    titlenelowBackground: "rgb(105 174 255)",
    titleBackground: "#fff",
...
const lightColors = {
  ...
  footer: {
    titlenelowBackground: "#2a569d",
    titleBackground: "#fff",
    fromBackground: "#94c3fc",
    toBackground: "#b6d7ff",
    belowBackground: "#2a569d",
  },
  dynamic_header: {
    afterbrandcolor: " #fff",
    color1brand: "#000",
...
return (
  ...
  >
    <div>
      ...
      <Widget
        src="lord1.near/widget/wrapped-base"
