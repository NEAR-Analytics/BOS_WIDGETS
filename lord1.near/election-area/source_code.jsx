...
const generaltheme = {
  ...
  align: "center",
  description:
    "Tracking the activity of Election, Voters and Candidates on the NEAR ecosystem.",
  brand: "Election Tracker 🏦",
  fontsize: "100",
  fontweight: "25px",
  afterbrand: "",
...
const areatheme = {
  height: "150px",
  align: "left",
  description: "In which categories are Election Participants most active?",
  brand: "Activity",
  fontsize: "300",
  fontweight: "25px",
...
const projecttheme = {
  height: "150px",
  align: "left",
  description: "Which projects do Election Participants use most?",
  brand: "Project",
  fontsize: "300",
  fontweight: "25px",
...
const flowtheme = {
  ...
  align: "center",
  description:
    "Election Participants inflow and outflow of funds from and to CEXs",
...
const staketheme = {
  height: "110px",
  align: "center",
  description: "NEAR staking and unstaking activity of Election Participants",
  brand: "Staking",
  fontsize: "100",
  fontweight: "15px",
  afterbrand: "Behavior",
...
const queryHashes = [
  ...
  { id: 2, hash: "ad6ab96b-c1e3-41eb-ad46-cea4ebb7f156" },
  { id: 3, hash: "3667cc1a-a927-42fd-a859-efdb5e945926" },
  { id: 4, hash: "e9cdfcf8-6260-4d74-adcb-bcc3608c4d78" },
  { id: 5, hash: "38526f64-de4b-4173-a1ab-07c17eb1c548" },
  ...
  { id: 11, hash: "d2e793a5-5706-4576-8621-288143ae60ba" },
];
    ...
    <div className="pl-2">
      ...
      >
        ...
        <div style={{ marginLeft: "1rem" }}>
          <Widget
            src="lord1.near/widget/tab-election-area"
            props={{
        ...
        <div className=" col-12 col-md-6">
          ...
          >
            <h6
              ...
              className="pt-4 ps-4"
            >
              <i> Age of Election Participant's wallets distribution</i>
            </h6>
            <Widget
        ...
        <div className=" col-12 col-md-6">
          ...
          >
            <h6
              ...
              className="pt-4 ps-4"
            >
              <i> Distribution of #Trxs among the Election Participants.</i>
            </h6>
            <Widget
              src="lord1.near/widget/Pie-chart"
              props={getPieProps(
                ...
                charts: [
                  {
                    title: "Volume(Near)",
                    subtitle:
                      "How much staked or unstaked by Election Participant wallets",
                    dateKey: "week",
                ...
                charts: [
                  {
                    title: "Near Volume",
                    subtitle:
                      "The Election participant's interactions with Cexs, inflow and outflow- Volume(Near)",
                    dateKey: "week",
