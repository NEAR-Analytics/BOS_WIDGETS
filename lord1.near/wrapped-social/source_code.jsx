...
const queries = [
...

  {
    ...
    sum(case when "type"='Like' then trxs else null end) as "like",
    sum(case when "type"='Post' then trxs else null end) as "post",
    sum(case when "type"='Received_Comment' then trxs else null end) as "received_comment",
    sum(case when "type"='Repost' then trxs else null end) as "repost",
    sum(case when "type"='Receive_Repost' then trxs else null end) as "receive_repost",
    sum(case when "type"='Poke' then trxs else null end) as "poke",
    sum(case when "type"='Receive_Poke' then trxs else null end) as "receive_poke",
    sum(case when "type"='Receive_Like' then trxs else null end) as "receive_like",
    sum(case when "type"='Widget' then trxs else null end) as "widget",
    sum(case when "type"='follow' then trxs else null end) as "follow"
    from final 
    group by 1 
    order by "date" asc  
    `,
