State.init({
  ...
  descriptions: {
    AMOUNT_NEAR: "Total Election Paticipant's transaction volume",
    fee: "Total Election Paticipant's transaction fees (in NEAR)",
    active_users: "Number of Election Paticipants",
    transactions: "Number of Election Paticipant's transactions",
  },
});
const data = fetch(
  "https://api.flipsidecrypto.com/api/v2/queries/2caecf75-1d32-4ddc-9b42-b7433dda65d1/data/latest"
);
