        ...
        <div>
          <Container>
            <ul className="tabContent">
              ...
              <li className="tab-item">
                <button
                  className={`${state.tab === tabs.rate ? "active" : ""}`}
                  aria-current="page"
                  onClick={() => setTab(tabs.rate)}
                >
                  Election Ratio
                </button>
              </li>
              ...
              <li className="tab-item">
                <button
                  className={`${state.tab === tabs.scan ? "active" : ""}`}
                  aria-current="page"
      ...
      <div>
        <div className="content">
          {state.tab === "info" && (
            <div>
              <Widget
                src="lord1.near/widget/election-candidates"
          ...
          {state.tab === "rate" && (
            <Widget
              src="lord1.near/widget/election-rate"
              props={{ themeColor: themeColor }}
            />
          )}
          {state.tab === "area" && (
            <Widget
              src="lord1.near/widget/election-area"
              props={{ themeColor: themeColor }}
            />
          )}
          {state.tab === "scan" && (
            <Widget
              src="lord1.near/widget/election-scan"
              props={{ themeColor: themeColor }}
            />
          )}
          {state.tab === "Explorer" && (
            <Widget
              src="lord1.near/widget/election-explorer"
              props={{ themeColor: themeColor }}
            />
          )}
        </div>
