...
const Transaction = (
  ...
  >
    <Widget
      src="lord1.near/widget/wrapped-transaction-avax"
      props={{
        themeColor,
...
const Platform = (
  ...
  >
    <Widget
      src="lord1.near/widget/wrapped-platform-avax"
      props={{
        themeColor,
        singer: state.searchedSinger,
        interval: state.searchedInterval,
...
const Swap = (
  <div
    className="w-100"
    style={{ display: state.tab === tabs.swap ? "" : "none" }}
  >
    <Widget
      src="lord1.near/widget/wrapped-swap-avax"
      props={{
        themeColor,
        singer: state.searchedSinger,
        interval: state.searchedInterval,
