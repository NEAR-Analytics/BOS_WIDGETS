...
function Hero({ ethereum }) {
  ...
  return (
    <SectionHeroStyle>
        ...
        <div className="row hero-content">
          <div className="hero-data">
            ...
            <p className="hero-description">
              Exchange your mobile data cross-carrier -
              {JSON.stringify(result) + ""}- seamlessly.
            </p>
            <ButtonStyle>
              <Web3Connect connectLabel="Connect with wallet" />
              <ContinueButtonStyle disabled={!isLogged}>
                Launch Packet App
              </ContinueButtonStyle>
            </ButtonStyle>
          </div>
      ...
      <IconStyle>
        {isLogged ? (
          <MobileData size={64} color={"green"} stroke={2} />
        ) : (
          <MobileData size={64} color={"red"} stroke={2} />
        )}
      </IconStyle>
    </SectionHeroStyle>
  );
