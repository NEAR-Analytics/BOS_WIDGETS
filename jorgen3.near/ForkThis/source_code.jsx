...
return (
  <Wrapper>
    <Header>
      <Widget src="hack.near/widget/Custom.Page.Content" />
      <h3>All Tutorials</h3>
      <Text>
    ...
    <Items>
      <Item>
        <Widget
          ...
          props={{ src: "hack.near/widget/bos-landing-page" }}
        />
      </Item>
      <Item>
        <Widget
          src="adminalpha.near/widget/ComponentCard"
          props={{ src: "hack.near/widget/Factory" }}
        />
      </Item>
      <Item>
        <Widget
          src="adminalpha.near/widget/ComponentCard"
          props={{ src: "hack.near/widget/ABC.Summary.Post" }}
        />
      </Item>
    </Items>
  </Wrapper>
