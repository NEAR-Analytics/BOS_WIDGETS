...
const network = props.network ?? "Ethereum Mainnet";
const coingeckoId = props.coingeckoId ?? "ethereum";

const accountId = context.accountId;

if (!tokenId) return "No tokenId";
...
const getErc20Tokendata = (tokenId) => {
  let dataUrl = `https://api.coingecko.com/api/v3/coins/${coingeckoId}/contract/${tokenId}`;
