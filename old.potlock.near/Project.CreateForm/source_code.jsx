...
if (!context.accountId) {
  return (
    <Widget
      src={"old.potlock.near/widget/Components.InfoSegment"}
      props={{
        title: "Not logged in!",
...
return (
  <Container>
    {!state.socialDataFetched || !registrations ? (
        ...
        <ButtonsContainer>
          ...
          <Widget
            ...
            props={{
              ...
              disabled: false,
              href:
                props.hrefWithParams && props.hrefWithParams(`?tab=projects`),
            }}
          />
        </ButtonsContainer>
      </>
      ...
      <>
        <Widget
          src={"old.potlock.near/widget/Profile.BannerHeader"}
          props={{
            ...props,
            projectId:
              state.isDao && state.daoAddress
            ...
            children: (
              <LowerBannerContainer>
                ...
                <LowerBannerContainerRight>
                  <Widget
                    src={"old.potlock.near/widget/Components.AccountsStack"}
                    props={{
        ...
        <FormBody>
          ...
          <FormSectionContainer>
            ...
            <FormSectionRightDiv>
              ...
              <Space height={24} />
              <Widget
                src={"old.potlock.near/widget/Inputs.SelectMultiple"}
                props={{
        ...
        />
        <Widget
          src={"old.potlock.near/widget/Project.ModalAddFundingSource"}
          props={{
            ...props,
