    ...
    <Wrapper>
        ...
        <div className="d-flex flex-column gap-2">
            {["Text", "TextSuper", "Vote", "Budget", "Motion"].includes(
                ...
                <Widget
                    src="megha19.near/widget/DAO.Proposal.Create.Text"
                    props={{
                        daoId,
                        onClose,
                        isCongressDaoID,
            ...
            {state.proposalType.value === "Transfer" && (
                <Widget
                    src="megha19.near/widget/DAO.Proposal.Create.Transfer"
                    props={{ daoId, onClose }}
                />
            )}
            {state.proposalType.value === "AddMemberToRole" && (
                <Widget
                    src="megha19.near/widget/DAO.Proposal.Create.AddMemberToRole"
                    props={{ daoId, onClose }}
                />
            )}
            {state.proposalType.value === "RemoveMemberFromRole" && (
                <Widget
                    src="megha19.near/widget/DAO.Proposal.Create.RemoveMemberFromRole"
                    props={{ daoId, onClose }}
                />
            )}
            {state.proposalType.value === "FunctionCall" && (
                <Widget
                    src="megha19.near/widget/DAO.Proposal.Create.FunctionCall"
                    props={{
                        daoId,
                        onClose,
                        isCongressDaoID,
            ...
            {(state.proposalType.value === "FundingRequest" ||
                ...
                <Widget
                    src="megha19.near/widget/DAO.Proposal.Create.FundingRequest"
                    props={{
                        daoId,
                        onClose,
            ...
            {state.proposalType.value === "Veto" && (
                <Widget
                    src="megha19.near/widget/DAO.Proposal.Create.Veto"
                    props={{
                        daoId,
                        dev: props.dev,
                        registry,
            ...
            {state.proposalType.value === "Dismiss" && (
                <Widget
                    src="megha19.near/widget/DAO.Proposal.Create.Dismiss"
                    props={{
                        daoId,
                        dev: props.dev,
                        registry,
            ...
            {state.proposalType.value === "Dissolve" && (
                <Widget
                    src="megha19.near/widget/DAO.Proposal.Create.Dissolve"
                    props={{
                        daoId,
                        dev: props.dev,
                        registry
            ...
            {state.proposalType.value === "ApproveBudget" && (
                <Widget
                    src="megha19.near/widget/DAO.Proposal.Create.ApproveBudget"
                    props={{
                        daoId,
                        dev: props.dev,
                        registry
            ...
            {state.proposalType.value === "UpdateBonds" && (
                <Widget
                    src="megha19.near/widget/DAO.Proposal.Create.UpdateBonds"
                    props={{
                        daoId,
                        dev: props.dev,
                        registry
            ...
            {state.proposalType.value === "UpdateVoteDuration" && (
                <Widget
                    src="megha19.near/widget/DAO.Proposal.Create.UpdateVoteDuration"
                    props={{
                        daoId,
                        dev: props.dev,
                        registry
