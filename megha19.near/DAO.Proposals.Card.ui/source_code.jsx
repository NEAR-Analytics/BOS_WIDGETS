                                ...
                                props={{
                                    children: (
                                        <div className="counter-text">
                                            <Widget
                                                src="megha19.near/widget/Common.Layout.Countdown"
                                                props={{
                                                    timeToCheck:
                                                        proposal?.submission_time +
                                                        (daoConfig?.vote_duration ??
...
function renderData({
    ...
    return (
        <div className="d-flex gap-2 flex-column">
            ...
            <Widget
                src="megha19.near/widget/Common.Modals.ProposalArguments"
    ...
    return (
        ...
        >
            ...
            {showVeto && (
                <div className="w-100">
                    <Widget
                        src="megha19.near/widget/DAO.Proposal.Common.VetoButton"
                        props={{
                            daoId,
                            proposal,
                            isCongressDaoID,
...
function renderMultiVoteButtons({ daoId, proposal, canVote }) {
    return (
        <Widget
            src="megha19.near/widget/DAO.Proposals.MultiVote"
            props={{
                daoId,
                proposal,
                canVote,
...
function renderFooter({ totalVotes, votes, comments, daoId, proposal }) {
    const items = [
        ...
        },
        {
            ...
            props: {
                url: `https://near.org/megha19.near/widget/home?page=dao&tab=proposals&daoId=${daoId}&proposalId=${
                    proposal.id
                }${props.dev ? "&dev=true" : ""}`,
        ...
        return (
            <Widget
                ...
                props={{
                    content: (
                        <Widget
                            src={`megha19.near/widget/${item.widget}`}
                            props={item.props}
                        />
                    ),
                    toggle: (
