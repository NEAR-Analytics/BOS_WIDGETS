...
} = VM.require(`megha19.near/widget/core.common`) || {
  PROPOSAL_TIMELINE_STATUS: {},
  parseJSON: () => {},
  isNumber: () => {},
  getLinkUsingCurrentGateway: () => {},
...
const proposalURL = getLinkUsingCurrentGateway(
  `megha19.near/widget/app?page=proposal&id=${proposal.id}&timestamp=${snapshot.timestamp}`
);
          ...
          <div className="d-flex flex-wrap gap-6">
            ...
            >
                ...
                <ProposalContainer className="rounded-2 flex-1">
                  ...
                  <div className="d-flex flex-column gap-1 p-2 px-3 description-box">
                    ...
                    <div className="d-flex gap-2 align-items-center mt-3">
                      <Widget
                        src={`megha19.near/widget/components.molecule.LikeButton`}
                        props={{
                          item,
              ...
              <div className="border-bottom pb-4 mt-4">
                <Widget
                  src={`megha19.near/widget/components.proposals.CommentsAndLogs`}
                  props={{
                    ...props,
                    id: proposal.id,
                    item: item,
              ...
              >
                <Widget
                  src={`megha19.near/widget/components.molecule.ComposeComment`}
                  props={{
                    ...props,
                    item: item,
                    notifyAccountIds: [authorId],
            ...
            >
              ...
              >
                <Widget
                  src={`megha19.near/widget/components.molecule.LinkedRfps`}
                  props={{
              ...
              >
                <Widget
                  src={`megha19.near/widget/components.molecule.LinkedProposals`}
                  props={{
