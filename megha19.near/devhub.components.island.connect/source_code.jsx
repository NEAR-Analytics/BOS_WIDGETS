...
const Cards = communities.map((com) => {
  return {
    ...
    href: "/megha2001.testnet/widget/app?page=community&handle=" + com.handle,
  };
});
...
const Content = (
  <>
    ...
    <CTAContainer>
      <CTA href="/megha2001.testnet/widget/app?page=communities">
...
return (
  <Widget
    src="megha2001.testnet/widget/devhub.components.island.home-section"
    props={{
      title: "/connect",
      children: Content,
      background: true,
