...
const getHouseUrl = (house) =>
    `#/megha19.near/widget/home?page=congress&house=${house}${
        props.dev && "&dev=true"
    }`;

const getMenuItems = () => {
    const widgetUrl = `#/megha19.near/widget/home?page=dao&daoId=${
        Content[state.selectedHouse].address
    }${props.dev && "&dev=true"}`;
            ...
            <Tabs className="flex-column mb-4">
                ...
                <div className="d-flex flex-column gap-4 p-2">
                    ...
                    {state.selectedTab === "proposals" && (
                        <Widget
                            src="megha19.near/widget/DAO.Proposals.Congress.index"
                            props={{
