...
return (
  <Wrapper>
    ...
    >
      <Widget
        src="megha19.near/widget/DAO.Proposals.Card.Arguments"
        props={{
          kind,
          daoId,
        }}
    ...
    <div className="w-100">
      ...
      {multiSelectMode ? (
        <Widget
          src="megha19.near/widget/DAO.Proposals.Card.MultiVote"
          props={{
            daoId,
            proposal,
            isAllowedToVote,
        ...
        <Widget
          src="megha19.near/widget/DAO.Proposals.Card.Vote"
          props={{
            daoId: daoId,
            proposal,
            isAllowedToVote,
