...
const { uuid, withUUIDIndex } = VM.require(
  "megha2001.testnet/widget/core.lib.uuid"
);
...
const KanbanViewConfigurator = ({ handle, data, permissions, onSubmit }) => {
  const tags = useCache(
    () =>
      Near.asyncView("devhub-dev.testnet", "get_all_labels").then(
        (res) => res
      ),
    handle,
    { subscribe: false }
            ...
            ({ id, description, tag, title }) => (
              ...
              >
                <div className="d-flex flex-column gap-1 w-100">
                  <Widget
                    src={`megha2001.testnet/widget/devhub.components.molecule.Input`}
                    props={{
                  ...
                  <div className="d-flex flex-column flex-1 align-items-start justify-content-evenly gap-1 p-2 flex-grow-1">
                    ...
                    <div className="w-100">
                      <Widget
                        src="megha2001.testnet/widget/devhub.feature.post-search.by-tag"
                        props={{
                          tag: tag,
  ...
  return (
    ...
    >
      ...
      {showPreview ? (
        <div>
          <Widget
            src={`megha2001.testnet/widget/devhub.entity.addon.kanban.Viewer`}
            props={{
              data: formState,
            }}
          />
