...
Near.asyncView(`queryapi.dataplatform.near`, "list_indexer_functions").then((data) => {
  const indexers = [];
...
const indexerView = (accountId, indexerName) => {
  const editUrl = `https://near.org/#/dataplatform.near/widget/QueryApi.App?selectedIndexerPath=${accountId}/${indexerName}`;
  const statusUrl = `https://near.org/#/dataplatform.near/widget/QueryApi.App?selectedIndexerPath=${accountId}/${indexerName}&view=indexer&activeIndexerView=status`;
  ...
  <Wrapper negativeMargin={state.activeTab === "explore"}>
    ...
    <Main>
      <Section active={state.activeTab === "explore"}>
        <NavBarLogo
          href={`https://near.org/#/dataplatform.near/widget/QueryApi.App`}
          title="QueryApi"
          onClick={() => selectTab("explore")}
        >
          <Widget
        ...
        <div>
          <ButtonLink
            href={`/#/dataplatform.near/widget/QueryApi.App/?view=create-new-indexer`}
          ...
          <Widget
            src={`dataplatform.near/widget/QueryApi.IndexerExplorer`}
          />
        </div>
      </Section>
      <Section
