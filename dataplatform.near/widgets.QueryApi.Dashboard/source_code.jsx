...
const indexerView = (accountId, indexerName, idx, view) => {
  ...
  const editUrl = `https://alpha.near.org/#/dataplatform.near/widget/QueryApi.Dashboard?selectedIndexerPath=${accountId}/${indexerName}&view=editor-window`;
  const statusUrl = `https://alpha.near.org/#/dataplatform.near/widget/QueryApi.Dashboard?selectedIndexerPath=${accountId}/${indexerName}&view=indexer-status`;
  ...
  <Wrapper negativeMargin={state.activeTab === "indexers"}>
    ...
    <Main>
      <Section active={state.activeTab === "indexers"}>
        <NavBarLogo
          href="https://alpha.near.org/#/dataplatform.near/widget/QueryApi.Dashboard"
          title="QueryApi"
          onClick={() => {
            State.update({
        ...
        <div>
          <ButtonLink
            href="/#/dataplatform.near/widget/QueryApi.Dashboard/?view=create-new-indexer"
      ...
      >
        {state.activeTab === "indexer-status" && (
          <div>
            ...
            <Widget
              src={"dataplatform.near/widget/QueryApi.IndexerStatus"}
              props={{
                indexer_name:
                  selected_indexerName ?? state.indexers[0].indexerName,
