              ...
              <div>
                ...
                >
                  <div class="row" style={{ color: "white", width: "100%" }}>
                    ...
                    <div class="col-3" style={{ fontSize: "11px" }}>
                      <span style={{ fontWeight: "bold" }}>Your Earnings</span>{" "}
                      <br />
                      {state.portfolio ? formatNumber(state.portfolio.fees) : 0}
                    </div>
                    <div class="col-3" style={{ fontSize: "11px" }}>
                      <span style={{ fontWeight: "bold" }}>Your Balance</span>{" "}
                      <br />
                      {state.portfolio ? formatNumber(state.portfolio.tvl) : 0}
                    </div>
                    <div
                      class="col-3"
                      style={{
              ...
              >
                          ...
                          >
                            ...
                            >
                              <div class="row">
                                ...
                                <div class="col-6">{formatNumber(p.fees)}</div>
                              </div>
                            </div>
                            <div
                ...
                {!state.portfolio && (
                  <p class="text-white">
                    ...
                    already added liquidity you must wait for the changes to be
                    reflected
                  </p>
                )}
              </div>
