...
if (state.lastRoomId !== 0 && !state.creatingRoom) {
  return (
    <Background>
      ...
      <pre class="text-danger bg-light">{`${website}${widgetOwner}/widget/CastlediceOnlineMantle?roomId=${state.lastRoomId}`}</pre>
      <BigButton
...
if (!state.creatorId && state.newRoomId === null) {
  ...
  return (
    <Background>
      ...
      <pre class="text-danger bg-light">{`${website}${widgetOwner}/widget/CastlediceWaitingRoomMantle?accountId=${sender}`}</pre>
...
if (state.newRoomId !== null) {
  return (
    <Background>
      ...
      <pre class="text-danger bg-light">{`${website}${widgetOwner}/widget/CastlediceOnlineMantle?roomId=${state.newRoomId}`}</pre>
    </Background>
  );
}
