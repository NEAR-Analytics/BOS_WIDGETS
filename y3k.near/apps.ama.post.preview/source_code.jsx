...
const question = JSON.parse(
  Social.get(`${accountId}/question/y3k`, blockHeight) ?? "null"
);
...
const link = `#/y3k.near/widget/apps.ama.post.page?accountId=${accountId}&blockHeight=${blockHeight}&adminContract=${adminContract}`;
  ...
  <div class="row">
    ...
    <div class="col-10">
          ...
          <div class="row">
            <H6>
              <div class="d-flex">
                ...
                <TopicName>
                  <Widget
                    src="y3k.near/widget/apps.ama.post.labels"
      ...
      <div class="row">
        <div class="col">
          <Widget
            src="y3k.near/widget/apps.ama.comment.repliesButton"
