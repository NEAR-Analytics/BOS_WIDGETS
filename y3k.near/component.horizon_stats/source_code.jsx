...
const rawData = fetch(
  "https://api.flipsidecrypto.com/api/v2/queries/5d5cbcca-59cc-47b7-8fcd-3f453ac302bd/data/latest",
  {
    subscribe: true,
    method: "GET",
    headers: {
...
console.log(rawData.body.length);
...
const header_map = {
  ...
  DVY: "Daily Average Transactions",
};
const getBarData = () => {
