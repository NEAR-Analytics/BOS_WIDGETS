...
async function swap() {
  ...
  asyncFetch("http://localhost:3001/swap").then((res) => {
    setData(
      "0x01013e1131e6cb8a1ea923be6907a4e7ca338ccd557a526a4876bebae4b68e6c"
    );
    setLoading(false);
    setSuccess(true);
  });
      ...
      <Encadre>
        ...
        <From
          ...
          onChange={(event) => {
            ...
            const parsedValue = parseInt(newValue, 10); // Use parseInt to convert to an integer

            setInputValue(isNaN(parsedValue) ? "" : parsedValue * 0.0036);
          }}
        />
