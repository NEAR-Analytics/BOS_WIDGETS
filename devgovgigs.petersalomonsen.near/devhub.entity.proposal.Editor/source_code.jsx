...
const CategoryDropdown = useMemo(() => {
  return (
    <Widget
      src={"devgovgigs.petersalomonsen.near/widget/devhub.entity.proposal.CategoryDropdown"}
      props={{
...
const ConsentComponent = useMemo(() => {
  return (
    <div className="d-flex flex-column gap-2">
      <Widget
        src={"devgovgigs.petersalomonsen.near/widget/devhub.components.molecule.Checkbox"}
        props={{
          value: "toc",
          label: (
            <>
...
const LinkedProposalsComponent = useMemo(() => {
  return (
    <div className="d-flex flex-column gap-1">
      ...
      <Widget
        src="devgovgigs.petersalomonsen.near/widget/devhub.entity.proposal.LinkedProposalsDropdown"
        props={{
