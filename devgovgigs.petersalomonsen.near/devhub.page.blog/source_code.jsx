...
if (showEditScreenData) {
  return (
    <EditorContainer>
      ...
      <Widget
        src={`devgovgigs.petersalomonsen.near/widget/devhub.entity.addon.blog.Configurator`}
        props={{
          ...showEditScreenData,
...
return (
  <div className="w-100">
    <Widget src={`devgovgigs.petersalomonsen.near/widget/devhub.components.island.banner`} />
    <HeaderContainer>
      <Header>Blog</Header>
    </HeaderContainer>
    <BlogContainer>
      <Widget
        src={"devgovgigs.petersalomonsen.near/widget/devhub.entity.addon.blog.Viewer"}
        props={{
