      ...
      <div class="row justify-content-between">
        <div class="d-flex align-items-center flex-wrap">
          <ProfileCardContainer>
            <Widget
              src={
                "devgovgigs.petersalomonsen.near/widget/devhub.components.molecule.ProfileCard"
              }
              props={{
          ...
          <div class="d-flex ms-auto">
            ...
            <Widget
              src={"devgovgigs.petersalomonsen.near/widget/devhub.entity.post.History"}
              props={{
                post,
      ...
      <div class="btn-group" role="group" aria-label="Basic outlined example">
        ...
        >
          ...
          {post.likes.length == 0 ? (
            ...
            <Widget
              src="devgovgigs.petersalomonsen.near/widget/devhub.components.layout.LikeButton.Faces"
              props={{
