...
return (
  <>
    <Widget
      src="devgovgigs.petersalomonsen.near/widget/devhub.components.atom.Alert"
      props={{
    ...
    <Tile className="p-3 mb-3">
      ...
      <Widget
        src="devgovgigs.petersalomonsen.near/widget/devhub.components.molecule.ListEditor"
        props={{
          data: {
            maxLength: 5,
    ...
    <div class="mt-3">
      {previewConnect && (
        <Widget
          src="devgovgigs.petersalomonsen.near/widget/devhub.components.island.connect"
          props={{ ...props }}
        />
      )}
    </div>
