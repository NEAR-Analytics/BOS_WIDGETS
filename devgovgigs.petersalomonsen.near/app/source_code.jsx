  ...
  switch (routes[0]) {
    ...
    case "announcements": {
      return (
        <Widget
          src={
            "devgovgigs.petersalomonsen.near/widget/devhub.page.announcements"
          }
          props={passProps}
        />
      );
    ...
    case "create-proposal": {
      return (
        <Widget
          src={
            "devgovgigs.petersalomonsen.near/widget/devhub.entity.proposal.Editor"
          }
          props={{ ...passProps }}
        />
      );
    ...
    case "blogv2": {
      return (
        <Widget
          src={"devgovgigs.petersalomonsen.near/widget/devhub.page.blogv2"}
          props={passProps}
        />
      );
    }
