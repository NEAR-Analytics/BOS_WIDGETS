  ...
  return (
    <>
      ...
      <div className="d-flex gap-4 flex-row flex-wrap justify-content-between">
        ...
        <Widget
          src="devgovgigs.petersalomonsen.near/widget/gigs-board.components.organism.configurator"
          props={{
            heading: "Card fields",
            classNames: { root: "col-12 col-md-4 h-auto" },
      ...
      <div className="d-flex flex-column align-items-center gap-3 w-100">
        ...
        <div className="d-flex gap-3 justify-content-end w-100">
          <Widget
            src="devgovgigs.petersalomonsen.near/widget/gigs-board.components.molecule.button"
            props={{
              classNames: {
...
return (
  ...
  >
    ...
    {form.values ? (
      <Widget
        src={`devgovgigs.petersalomonsen.near/widget/gigs-board.entity.workspace.view.${form.values.metadata.type}`}
        props={{
          ...form.values,
