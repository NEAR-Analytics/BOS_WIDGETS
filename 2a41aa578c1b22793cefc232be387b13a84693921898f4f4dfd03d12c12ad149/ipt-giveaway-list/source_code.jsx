...
const isAllowedToJoinGA = () => Number(userStatus) === 2;
...
const renderTooltipText = () => {
  if (Number(userStatus) === 1) {
    return "Your documents is being verified";
  }

  if (Number(userStatus) === 3) {
    return "Your documents has been rejected. Please submit again on Fractal";
  }
