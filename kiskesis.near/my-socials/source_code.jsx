const telegramURL = props.telegramURL || null;
const twitterURL = props.twitterURL || null;
const nearSocialURL = props.nearSocialURL || null;
const textOptions = props.textOptions || {
  textColor: "white",
  text: null,
};
const iconsOptions = props.iconsOptions || {
  telegram: "#fff",
  twitter: "#fff",
  nearSocial: "#EBEFEC",
};
...
return (
  <WrapperSocial>
    {textOptions.text && <SocialText>{textOptions.text}</SocialText>}
    {twitter && (
      <SocialButton>
    ...
    {nearSocialURL && (
      <SocialButton>
        <SocialLink href={nearSocialURL} target="_blank">
          <svg
            width={16}
            height={16}
            viewBox="0 0 16 16"
    ...
    {telegramURL && (
      <SocialButton>
        <SocialLink href={telegramURL} target="_blank">
          <svg
            width={18.462}
            height={16}
