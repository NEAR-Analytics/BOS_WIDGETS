...
if (!state.registeredProjects) {
  State.update({
    registeredProjects: Near.view(registryContractId, "get_projects", {}),
  });
}
      ...
      Near.asyncView("social.near", "get", {
        ...
        const formattedProjects = projects.map((project) => {
          ...
          if (profileData.backgroundImage) {
            const imageUrl = getImageUrlFromSocialImage(
          ...
          const formatted = {
            ...
            tags: [
              profileData.category.text ??
                CATEGORY_MAPPINGS[profileData.category] ??
                "",
            ],
          };
          return formatted;
...
const props = {
  ...
  SUPPORTED_FTS: {
    ...
    NEAR: {
      iconUrl:
        IPFS_BASE_URL +
        "bafkreicwkm5y7ojxnnfnmuqcs6ykftq2jvzg6nfeqznzbhctgl4w3n6eja",
