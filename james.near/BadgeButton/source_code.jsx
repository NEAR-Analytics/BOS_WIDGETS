...
const data = {
  badge: {
    builder: {
      [accountId]: isBuilder ? null : `${color}`,
    },
  },
  index: {
...
return (
  <Wrapper className={props.className}>
    <div className="mb-2">
      <input
        type="text"
        placeholder="red, green, blue, yellow, purple, gray, brown, orange, maroon, pink, white, black, rust, etc."
        value={color}
        onChange={(e) => setColor(e.target.value)}
      />
    </div>
    <div className="d-flex flex-row gap-2 m-1">
      <CommitButton
        onCommit={() => {
          props.onCommit();
        }}
      ...
      <Widget src="james.near/widget/BuilderHat" props={{ color }} />
    </div>
  </Wrapper>
);
