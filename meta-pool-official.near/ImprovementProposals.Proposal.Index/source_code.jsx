    ...
    <div>
      <Widget
        ...
        props={{
          ...
          className: "mt-2",
          variant: "primary",
          href: `meta-pool-official/widget/ImprovementProposals?tab=home`,
        }}
      />
    </div>
    <ContentContainer>
          ...
          <ButtonsContainer>
            <Widget
              ...
              props={{
                ...
                className: "mt-2",
                variant: "primary",
                href: `/meta-pool-official/widget/ImprovementProposals.Proposal.Create.Index?edit=true&mpip_id=${mpip_id}`,
              }}
            />
            <Widget
              src={`${authorId}/widget/Common.Button`}
