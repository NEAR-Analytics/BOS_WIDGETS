...
const { routes } = VM.require("abdullahi3000.near/widget/config.app") ?? {
  routes: {},
};

const { AppLayout } = VM.require(
  "abdullahi3000.near/widget/template.AppLayout"
) || {
  AppLayout: () => <></>,
};
  ...
  return (
    <div key={active}>
      <Widget
        src={src}
        props={{
          currentPath: `/abdullahi3000.near/widget/app?page=${page}`,
          page: tab,
          ...passProps,
          ...defaultProps,
        }}
