  ...
  <>
    <SwapContainer>
      <Panel className="">
        ...
        <Widget
          src="dapdapbos.near/widget/Base.Uniswap.Swap.CurrencyInput"
          props={{
            account,
        ...
        {state.inputCurrency && state.outputCurrency && state.trade && (
          <Widget
            src="dapdapbos.near/widget/Base.Uniswap.Swap.Result"
            props={{
              trade: {
                ...state.trade,
        ...
        {state.showPriceImpactWarning && (
          <Widget
            src="dapdapbos.near/widget/Base.Uniswap.Swap.PriceImpactWarningButton"
            props={{
        ...
        <Widget
          src="dapdapbos.near/widget/Base.Uniswap.Swap.SwapButton"
          props={{
      ...
      {account && (
        <Widget
          src="dapdapbos.near/widget/Base.Uniswap.Swap.BridegeTips"
          props={{
            onClick: () => {
              props.onOpenBridge();
            },
      ...
      {state.displayCurrencySelect && (
        <Widget
          src="dapdapbos.near/widget/Base.Uniswap.Swap.CurrencySelect"
          props={{
    ...
    {state.showSlippageSetting && (
      <Widget
        src="dapdapbos.near/widget/Base.Uniswap.Swap.SlippageSetting"
        props={{
    ...
    {state.showRoutes && state.trade && (
      <Widget
        src="dapdapbos.near/widget/Base.Uniswap.Swap.Routes"
        props={{
          clientX: state.clientX,
          clientY: state.clientY,
    ...
    {state.showSlippageAmount && state.trade && (
      <Widget
        src="dapdapbos.near/widget/Base.Uniswap.Swap.SlippageAmount"
        props={{
          clientX: state.clientX,
          clientY: state.clientY,
          slippage,
    ...
    {state.showPriceImpactTips && (
      <Widget
        src="dapdapbos.near/widget/Base.Uniswap.Swap.PriceImpactWarning"
        props={{
          clientX: state.clientX,
          clientY: state.clientY,
          onClose: () => {
