        ...
        <Content>
          ...
          <ScrollContent>
            ...
            <CurrencyList>
              ...
              {state.importToken && (
                <Widget
                  src="dapdapbos.near/widget/Base.Uniswap.Swap.CurrencyImportRow"
                  props={{
              ...
              {state.tokens?.map((currency) => (
                <Widget
                  src="dapdapbos.near/widget/Base.Uniswap.Swap.CurrencyRow"
                  props={{
          ...
          <Widget
            src="dapdapbos.near/widget/Base.Uniswap.Swap.ImportWarning"
            props={{
