  ...
  <Wrapper>
    <div class="card">
      ...
      <div class="content">
        ...
        <p class="description">Studentica 3. godine FER-a</p>
        <a href="mailto:[email-address]" class="save-button">
          janabulum7@gmail.com
        </a>
        <div class="social-links">
          <a href="[linkedin-url]" class="social-link linkedin">
            LinkedIn
          </a>
          <a href="[github-url]" class="social-link twitter">
            Github
          </a>
          <a href="[twitter-url]" class="social-link twitter">
            Twitter
          </a>
        </div>
      </div>
