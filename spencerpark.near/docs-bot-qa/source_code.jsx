...
const urlForModel = (model) => {
  switch (model) {
    case "near-docs":
      return `https://9386-34-125-214-61.ngrok-free.app/query`;
  }
};
const nearDocs = async (question) => {
  return asyncFetch(`https://9386-34-125-214-61.ngrok-free.app/query`, {
    method: "POST",
    headers: {
      "Content-Type": "application/x-www-form-urlencoded",
    },
    responseType: "json",
    body: `openai_key=${credential}&question=${question.content}`,
  }).then((response) => {
