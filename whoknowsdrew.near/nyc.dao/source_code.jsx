...
const contractId = "whoknowsdrew.near";
const pageUrl = `#/near/widget/nyc.dao`;
...
State.init({
  selectedTab: props.tab || "brooklyn",
});
...
return (
  <Wrapper>
    ...
    <Content>
      <Tabs>
        <TabsButton
          href={`${pageUrl}&tab=brooklyn`}
          selected={state.selectedTab === "brooklyn"}
        >
          brooklyn
        </TabsButton>

        <TabsButton
          href={`${pageUrl}&tab=manhattan`}
          selected={state.selectedTab === "manhattan"}
        >
          manhattan
        </TabsButton>

        <TabsButton
          href={`${pageUrl}&tab=bronx`}
          selected={state.selectedTab === "bronx"}
        >
          bronx
        </TabsButton>

        <TabsButton
          href={`${pageUrl}&tab=queens`}
          selected={state.selectedTab === "queens"}
        >
          queens
        </TabsButton>

        <TabsButton
          href={`${pageUrl}&tab=staten`}
          selected={state.selectedTab === "staten"}
        >
          staten
        </TabsButton>
      </Tabs>

      {state.selectedTab === "brooklyn" && (
        <Widget
