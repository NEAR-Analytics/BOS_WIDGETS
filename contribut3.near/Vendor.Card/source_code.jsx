...
if (!state.contributionsIsFetched) {
  Near.asyncView(
    ...
    "final",
    false
  ).then((contributions) => State.update({ contributions, contributionsIsFetched: true }));
}
    ...
    <Container>
      ...
      <Details>
        ...
        <Row>
          ...
          <Widget src={`${ownerId}/widget/ActiveIndicator`} props={{ active: state.profile.active, activeText: "Available", inactiveText: "Not available" }} />
        </Row>
        <Widget
