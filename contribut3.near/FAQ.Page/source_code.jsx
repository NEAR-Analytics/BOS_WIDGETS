...
return (
  <Container>
    <Widget
      src={"contribut3.near/widget/InfoSegment"}
      props={{
        title: "Need help?",
        description: (
          <>
    ...
    <Section>
      ...
      <p>
        ...
        <a href="https://near.org/contribut3.near/widget/Index?tab=createproject">
          create a project{" "}
        </a>
        in the project page.
        <br />
      ...
      <p>
        <strong>3.</strong>
        <a href="https://near.org/contribut3.near/widget/Index">
          {" "}
      ...
      <p>
        <strong>5.</strong>{" "}
        <a href="https://near.org/contribut3.near/widget/Index?tab=help">
          Additional help
          <br />
          <img
