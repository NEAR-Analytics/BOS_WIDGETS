...
const contracts = props.contracts ||
  context.contracts || ["bonerz.mintbase1.near"];
const marketId = "simple.market.mintbase1.near";

const AFFILIATE_ACCOUNT = props.affiliateAccount || "bonerz.near";
...
return data !== null ? (
  <>
    <div>
      ...
      <p>1/1 pixel art collection...having some fun</p>
    </div>
        ...
        (listing, i) => {
          ...
          return (
            <div className="d-flex flex-column gap-1">
              <a
                href={`https://mintbase.xyz/meta/${listing.metadata_id}?affiliateAccount=bonerz.near/`}
                target="_blank"
              >
                <Widget
