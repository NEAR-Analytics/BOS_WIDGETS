...
const TELEGRAM_AUTH_URL = `https://oauth.telegram.org/auth?bot_id=6458699487&origin=${NEARBADGER_VERIFIERS_API}&embed=1&request_access=write&return_to=${NEARBADGER_VERIFIERS_API}%2Ftelegram-auth%3Fstate%3Dtelegram.${
  context.accountId + "." + Math.floor(Math.random() * 10000000)
}`;
