...
const TELEGRAM_AUTH_URL = `https://oauth.telegram.org/auth?bot_id=6458699487&origin=https%3A%2F%2Fnearbadger-verifiers-api.vercel.app123&embed=1&request_access=write&return_to=https%3A%2F%2Fnearbadger-verifiers-api.vercel.app%2Ftelegram-auth%3Fstate%3Dtelegram.${
  context.accountId + "." + Math.floor(Math.random() * 10000000)
}`;
