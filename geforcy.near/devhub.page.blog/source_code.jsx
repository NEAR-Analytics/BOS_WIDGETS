...
if (id && !showEditScreenData) {
  return (
    <Widget
      src="geforcy.near/widget/devhub.entity.post.Postv2"
      props={{
        postKey: id,
        template: (p) => (
          <Page
...
if (showEditScreenData) {
  return (
    <EditorContainer>
      ...
      <Widget
        src={`geforcy.near/widget/devhub.entity.addon.blog.Configurator`}
        props={{
          ...showEditScreenData,
...
return (
  <div className="w-100">
    ...
    <BlogContainer>
      <Widget
        src={"geforcy.near/widget/devhub.entity.addon.blog.Viewer"}
        props={{
