const { normalize } = VM.require("geforcy.near/widget/core.lib.stringUtils");
...
const tabs = [
  community.enabled_default_tabs.includes("Announcements") && {
    title: "Announcements",
    view: "geforcy.near/widget/devhub.entity.community.Announcements",
    params: {
  ...
  community.enabled_default_tabs.includes("Discussions") && {
    title: "Discussions",
    view: "geforcy.near/widget/devhub.entity.community.Discussions",
    params: {
      handle: community.handle,
  ...
  community.enabled_default_tabs.includes("Activity") && {
    title: "Activity",
    view: "geforcy.near/widget/devhub.entity.community.Activity",
    params: {
      handle: community.handle,
    },
  },
  community.enabled_default_tabs.includes("Teams") && {
    title: "Teams",
    view: "geforcy.near/widget/devhub.entity.community.Teams",
    params: {
      handle: community.handle,
    },
  },
...
(community.addons || []).map((addon) => {
  addon.enabled &&
    tabs.push({
      ...
      view: "geforcy.near/widget/devhub.page.addon",
      params: { addon },
    });
});
    ...
    <div className="container d-flex flex-wrap justify-content-between align-items-center align-items-md-start gap-4">
      ...
      <div className="d-flex align-items-end gap-3 ms-auto mb-md-5 me-4">
        {permissions.can_configure && (
          <Link
            to={`/geforcy.near/widget/app?page=community.configuration&handle=${community.handle}`}
          >
            <Widget
