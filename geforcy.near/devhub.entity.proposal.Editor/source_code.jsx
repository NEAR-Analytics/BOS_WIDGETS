...
if (!author) {
  return (
    <Widget src={"geforcy.near/widget/devhub.entity.proposal.LoginScreen"} />
  );
}
...
if (isEditPage) {
  editProposalData = Near.view("thomasguntenaar.near", "get_proposal", {
...
useEffect(() => {
  if (
    ...
    editProposalData.snapshot.linked_proposals.map((item) => {
      useCache(
        () =>
          Near.asyncView("thomasguntenaar.near", "get_proposal", {
...
if (showProposalPage) {
  return (
    <Widget
      src={"geforcy.near/widget/devhub.entity.proposal.Proposal"}
            ...
            <div className="d-flex gap-2 w-100">
              ...
              <div className="d-flex flex-column gap-4 w-100">
                ...
                >
                  <Widget
                    src={
                      "geforcy.near/widget/devhub.components.molecule.Compose"
                    }
                    props={{
                      data: description,
            ...
            <div className="my-2">
              <CollapsibleContainer title="Link Proposals (Optional)">
                <div className="d-flex flex-column gap-1">
                  ...
                  <Widget
                    src="geforcy.near/widget/devhub.entity.proposal.LinkedProposalsDropdown"
                    props={{
                      onChange: (v) => {
                        if (
