...
return (
  <Root>
    ...
    <Container>
      <Widget
        src="geforcy.near/widget/devhub.entity.addon.blog.editor.provider"
        props={{
          handle: props.handle,
          Layout: (providerProps) => {
            ...
            return (
              <Widget
                src="geforcy.near/widget/devhub.entity.addon.blog.editor.layout"
                props={{
                  getData,
                  editData: editData,
                  Sidebar: (p) => (
                    <Widget
                      src="geforcy.near/widget/devhub.entity.addon.blog.editor.sidebar"
                      props={{
                        ...p,
                        ...providerProps,
                      }}
                  ...
                  Content: (p) => (
                    <Widget
                      src="geforcy.near/widget/devhub.entity.addon.blog.editor.content"
                      props={{
                        onChange,
                        onCancel,
                        onSubmit,
