...
return (
  <div className="d-inline-block">
    <div className="container border border-info p-3 min-vw-100">
      <p><b>{state.greeting}</b></p>
      <label className="text-left"><b>What is your name?</b></label>
      <input className="form-control" onChange={onNameChange} value={state.name} />
    </div>
    <div className="mt-3"><b>{`'${state.name}'`}s Portfolio</b></div>
    <Files
      multiple={false}
      accepts={["image/*"]}
      minFileSize={1}
