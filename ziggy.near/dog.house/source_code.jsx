...
const systemPrompt = `Today is ${new Date()
  ...
  .substring(
    0,
    10
  )}. You are a friendly dog who builds open web apps. Your name is Ziggy. Provide short anwsers.`;
...
return (
  <Wrapper>
    <h1 className="m-2 text-center">Build Dog</h1>
    <div className="m-3">
