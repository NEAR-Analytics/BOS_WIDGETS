              ...
              <Container>
                <div className="row">
                  <div className="col-md-8">
                    ...
                    <FormSection>
                      <label htmlFor="publicGood">
                        Why Do you consider yourself a public good?
                      </label>
                      <textarea
                        className="form-control"
                        id="publicGood"
                        ...
                        onChange={(e) =>
                          handleInputChange("publicGoodReason", e.target.value)
                        }
                      />
                    </FormSection>
                    <FormSection>
                    ...
                    <Sidebar>
                      ...
                      <FormSection>
                        <input
                          ...
                          placeholder="https://github.com/repo1"
                          value={state.repo1}
                          onChange={(e) =>
                            handleInputChange("repo1", e.target.value)
                          }
                        />
                        <input
                          type="text"
                          className="form-control"
                          placeholder="https://github.com/repo2"
                          value={state.repo2}
                          onChange={(e) =>
                            handleInputChange("repo2", e.target.value)
                          }
                        />
                      </FormSection>
                  ...
                  <div className="col-md-8">
                    ...
                    <ConsentSection>
                      <div className="form-check mb-2">
                        ...
                        >
                          I've agreed to AIPGP's Terms and Conditions and commit
                          to honoring it
                        </label>
                      </div>
                      <div className="form-check mb-2">
                        <input
                          ...
                          onChange={() =>
                            handleInputChange("codeConduct", !state.codeConduct)
                          }
                        />
                        <label
                          className="form-check-label"
                          htmlFor="codeConduct"
                        >
                          I've read DevHub's Code of Conduct and commit to
                          honoring it
                        </label>
                      </div>
                    </ConsentSection>
