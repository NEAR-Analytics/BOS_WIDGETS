...
const proposalQueryName =
  "megha19_near_forum_potlock_proposals_with_latest_snapshot";
...
const rfpQueryName = "megha19_near_forum_potlock_rfps_with_latest_snapshot";
...
async function getSuggestedRfps(id) {
  ...
  await asyncFetch("https://near-queryapi.api.pagoda.co/v1/graphql", {
    method: "POST",
    headers: { "x-hasura-role": "megha19_near" },
    body: JSON.stringify({
      query: rfpQuery,
      variables: variables,
