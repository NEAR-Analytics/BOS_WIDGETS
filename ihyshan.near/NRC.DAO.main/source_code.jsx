...
const accountId = props.accountId ?? "research-collective.near";
...
const accountUrl = `#/${widgetOwner}/widget/NRC.DAO.main?daoId=${daoId}&issuer=${issuer}&accountId=${accountId}&role=${role}`;
...
return (
  <Wrapper>
    ...
    <Main>
      <SidebarWrapper>
        <Widget
          src="ihyshan.near/widget/DAO.main.sidebar"
          props={{
            daoId: daoId,
            profile,
            role: role,
