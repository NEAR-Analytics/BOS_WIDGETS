  ...
  >
    <div className={`post ${props.reposted ? "reposted" : ""}`}>
      ...
      <div className="right">
        <Widget
          ...
          src="blueprints.near/widget/Components.Post.Header"
          props={{
            accountId,
            blockHeight,
            pinned,
    ...
    {state.showReply && (
      <div>
        <Widget
          loading=""
          src="blueprints.near/widget/Components.Comment.Compose"
          props={{
            notifyAccountId,
            item,
    ...
    {props.customComments
      ...
      : !props.hideComments && (
          <Widget
            key="comments"
            loading={false}
            src="blueprints.near/widget/Components.Comment.Feed"
            props={{
              item,
