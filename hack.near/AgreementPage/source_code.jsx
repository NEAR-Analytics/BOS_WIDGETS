  ...
  <Container>
    ...
    <p>
      <span>
        ...
        it. It provides for your rights and obligations to NEAR Builders
        Cooperative, a Colorado limited cooperative association (the
        “Cooperative”).
      </span>
    </p>
    <h5>
    ...
    <ul>
      <li>
        ...
        education, and onboarding. The goal is to create a positive impact
        everywhere by increasing accessibility of blockchain technology,
        enhancing the quality of experience for builders, and cultivating
        successful open web applications.
      </li>
      <li>
    ...
    <p>
      <span>
        ...
        with the Secretary of State of Colorado, as amended from time to time
        (“Articles”), Bylaws of the Cooperative, as amended from time to time
        (“Bylaws”), and the Charter. You are encouraged to become familiar with
    ...
    <ul>
      ...
      <li>
        ...
        governance decisions, as provided for in the Bylaws of the Cooperative,
        and other decisions put to a vote of the members, including concerning
        retroactive compensation. The Cooperative may adopt other policies
        specifying the activities that are considered patronage and you will
        receive notice of those before being obligated to engage in such
        activities.
      </li>
      <li>
        Agree to be bound by Cooperative’s Bylaws and the Articles, the Charter
        and other policies of the Cooperative, and you are aware that you can
        request a copy of the Bylaws.
      </li>
      <li>
    ...
    <ul>
      <li>
        ...
        are entitled to reimbursement of the membership fee that you paid, if
        any was paid, should you decide to no longer be a member in the
        Cooperative.
      </li>
      <li>
        ...
        notice; however, the Council may not eliminate your financial rights and
        terminate your membership if you are a member in good standing. In case
        of changes to your benefits, the Cooperative will make such information
        available through its website, app, or another technology that gives you
        proper notice, and you accept the use of the Cooperative’s technology
        for these purposes. Future potential financial distributions related to
        your Cooperative membership cannot be taken away by the Council.
      </li>
      <li>
        ...
        share your perspective, feedback, and advice for decisions which impact
        you. Additionally, the Cooperative will make major decisions, which
        impact most members, through a combination of proposals and off and
        on-chain voting, and the Member has the responsibility to work with the
        proposers to improve the proposals.
      </li>
      <li>
      ...
      <li>
        ...
        occasion for extraordinary dividends to be paid to Cooperative members,
        you may be entitled to some financial distributions that could result in
        a taxable event that you have a responsibility to claim on your tax
        returns.
      </li>
      <li>
      ...
      <li>
        ...
        satisfy your financial obligations to the Cooperative; however, you may
        not require that the Cooperative offset any debts or claims that you owe
        to the Cooperative against any amounts that the Cooperative may owe to
        you.
      </li>
      <li>
        Understand that the Council and its representatives and the Admins have
        the authority to enforce the terms of this Agreement.
      </li>
      <li>
        Understand that the Cooperative’s Council or a vote of the Members may
        result in your termination if you fail to fulfil your obligations to the
        Cooperative. You acknowledge that you have access to the Bylaws
        describing the situations where this may happen and the procedure to be
        followed.
      </li>
    </ul>
    <h5>
    ...
    <ul>
      <li>
        ...
        any and all damages, liabilities, losses, costs, expenses, obligations,
        claims, suits, judgments, settlements, and demands (including reasonable
        attorneys' fees and costs), incurred or suffered by the Cooperative as a
        result of or arising from: (a) any breach of this Agreement by the
        Member, including any representation or warranty made by the Member
        herein; (b) any act or omission by the Member in connection with the
        Member's participation in the Cooperative; (c) any negligence or wilful
        misconduct by the Member, or its officers, employees, agents,
        affiliates, or representatives, in connection with the Member's
        performance under this Agreement; or (d) any violation of any law or
        regulation by the Member. The Member's obligations under this section
        shall survive any termination or expiration of this Agreement.
      </li>
      <li>
        <b>Limitation of Liability.</b> The Cooperative is not responsible for
        any losses or damages that happen because of the Member's membership and
        the Member’s use of information that is beyond the Cooperative's
      ...
      <li>
        ...
        additional documents that the Cooperative decides that are necessary to
        fulfil this Agreement and the Member’s obligations to the Cooperative.
      </li>
      <li>
        <b>Term and Termination.</b> This Agreement lasts for as long as the
        Member is a Member in the Cooperative; and termination of the Member is
      ...
      <li>
        ...
        Agreement to be binding and to bind their heirs, legal representatives,
        successors, and assigns, for as long as there is a membership
      ...
      <li>
        ...
        in the U.S. jurisdiction against whom any claims are brought under this
        Agreement.
      </li>
      <li>
        ...
        Agreement, and any other agreements between you and the Cooperative, and
        (ii) if we are unable to resolve the dispute through discussion, we
        agree to submit that dispute to mediation and the dispute resolution
        mechanism indicated in the Charter and other policies of the
        Cooperative, before the dispute is arbitrated or taken to court. In any
        event, you agree to and by signing this Agreement you do WAIVE ANY RIGHT
        TO A JURY.
      </li>
    </ul>
    <br />
