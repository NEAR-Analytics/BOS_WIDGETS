  ...
  <Wrapper>
    <Container>
      <LogoAndIcons>
        ...
        <Icons>
          <a href="#" target="_blank" title="Official Twitter account">
          ...
          <a href="#" target="_blank" title="Official Github organization">
          ...
          <a href="#" target="_blank" title="Official Telegram channel">
          ...
          <a href="#" target="_blank" title="Official YouTube channel">
      ...
      <LinkGrid>
        <div>
          ...
          <ul>
            <li>
              <a href="https://marmajgaming.near.social/">MarmaJ Gaming</a>
            </li>
            <li>
              <a href="https://research-collective.near.social/">
                Research Collective
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul>
            <li>
              <a href="https://potlock.io/about">Overview</a>
            </li>
            <li>
              <a href="https://potlock.io/github">Github</a>
            </li>
            <li>
              <a href="https://NEAReFi.org">NEAReFi</a>
            </li>
            <li>
              <a href="https://potlock.io/bos">BOS Profile</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            <li>
              <a href="https://potlock.io/docs">Fork Us</a>
            </li>
            <li>
              <a href="https://potlock.io/accelerator">Apply to Accelerator</a>
            </li>
            <li>
              <a href="https://potlock.io/human">Verify As Human</a>
            </li>
            <li>
              <a href="https://NEAReFi.org/subscribe">Subscribe</a>
            </li>
          </ul>
        </div>
      </LinkGrid>
