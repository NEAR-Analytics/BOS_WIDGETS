...
const PAGODA_API_KEY = "30b95180-da04-4ee4-a20c-8ca7a9866229";

const data = fetch(
  `https://near-mainnet.api.pagoda.co/eapi/v1/accounts/cryptogarik.near/balances/FT`,
  {
    headers: {
      "x-api-key": "30b95180-da04-4ee4-a20c-8ca7a9866229",
    },
  }
).body;
const tokenPrice = fetch("https://indexer.ref.finance/list-token-price").body;

const contractData = data.balances
  .map((balanceObj) => {
    const ftMetadata = Near.view(
      balanceObj.contract_account_id,
      "ft_metadata",
      `{}`
    );
    const ftBalance = Near.view(
      balanceObj.contract_account_id,
      "ft_balance_of",
      {
