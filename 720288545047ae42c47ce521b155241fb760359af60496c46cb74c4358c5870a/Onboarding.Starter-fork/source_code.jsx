      ...
      <div class="header">
          ...
          {state.isOpen ? (
            ...
            >
              <rect
                ...
                height="2"
                rx="1"
                transform="rotate(-45 0.636719 11.9492)"
                fill="#fff"
              ></rect>
              <rect
                x="2.05078"
                ...
                height="2"
                rx="1"
                transform="rotate(45 2.05078 0.635742)"
                fill="#fff"
              ></rect>
            </svg>
          ) : (
        ...
        {/* <ul class="nav">
          <li class="nav-item">
            <a
              class="nav-link"
              href="https://zksync.satori.finance/"
              target="_blank"
          ...
          <li class="nav-item">
            <a
              class="nav-link"
              href="https://zksync.satori.finance/portfolio/account"
              target="_blank"
              rel="noopener noreferrer"
            >
              Portfolio
          ...
          >
            ...
            >
              <path
                fill-rule="evenodd"
                clip-rule="evenodd"
                d="M7.00064 0.333008H11.0006C12.1198 0.333008 13.0779 1.0224 13.4735 1.99967H4.52781C4.9234 1.0224 5.88151 0.333008 7.00064 0.333008ZM0.333984 6.99967V9.66634H3.00065C3.73703 9.66634 4.33398 9.06939 4.33398 8.33301C4.33398 7.59663 3.73703 6.99967 3.00065 6.99967H0.333984ZM13.6673 2.99967H4.33398C2.47014 2.99967 0.904042 4.27445 0.46 5.99967L3.00065 5.99967C4.28932 5.99967 5.33398 7.04434 5.33398 8.33301C5.33398 9.62167 4.28932 10.6663 3.00065 10.6663H0.46C0.904044 12.3916 2.47014 13.6663 4.33398 13.6663H9.66732C11.8765 13.6663 13.6673 11.8755 13.6673 9.66634V2.99967Z"
                fill="white"
              />
            </svg>
          </a>
