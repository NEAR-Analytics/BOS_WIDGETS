...
const earnRewardsApr = (state.aprData.rewards.earn_rewards_apr || 0) * 100;
  ...
  <>
    ...
    <InfoSection marginTop={12}>
      <InfoRow>
        ...
        <InfoValue>
          {Number(state.aprData.supplyApr || 0).toFixed(2)}%
        </InfoValue>
      </InfoRow>
      <InfoRow>
      ...
      <InfoRow>
        ...
        <InfoValue>
          {Number(earnRewardsApr + state.aprData.supplyApr || 0).toFixed(2)}%
        </InfoValue>
      </InfoRow>
    </InfoSection>
  </>
