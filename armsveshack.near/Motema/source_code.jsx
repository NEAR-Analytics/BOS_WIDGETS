...
function Modal({ onClose, show, children }) {
  ...
  return (
    ...
    >
      ...
      >
        <div class="rounded-lg bg-lime-300 py-4 px-4 border-2">{children}</div>
      </div>
    </div>
  );
}
...
return (
  <Theme>
    <div class="main-container">
      <Navbar>
        <img
          src="https://i.ibb.co/VD1Gsd7/motema-banner.png"
          alt="Motema Banner"
        ></img>
      </Navbar>
      <div class="header">
      ...
      >
        {props.grams && productName ? (
          <>
            <span>
              <p>
                You just purchased {productName} which contains {props.grams}{" "}
                grams of cobalt!
              </p>
              <p>
                Do you want to help reduce the impact of cobalt mining in
                Democratic Republic of Congo? Donate to the cause!
              </p>
              <p>
                The money will be used to support the local communities and help
