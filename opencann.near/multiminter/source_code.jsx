// source: mattb.near/widget/GenaDrop.MultiChainMinter

// TO DO:
// Enable user input selection for 1155 and Hypercerts  //
// Enable user input selection for isSoulbound

const OWNER_ID = "opencann.near";
