return (
  <div>
    ...
    <p>
      My Name is Navneet Shrivastava, originally from India, I have a Bachelor
    ...
    <p>
      ...
      implementing Applications, and optimizing data pipelines to fuel informed
      decision-making.
    </p>
    <ul>
      <li>
      ...
      <li>
        🛠️ Tech Enthusiast: I am deeply committed to staying at the forefront of
        technological advancements in the data engineering landscape. My toolkit
        includes [list relevant programming languages, databases, and
        frameworks, e.g., Python, SQL, PySpark, AWS Services like Glue, Lambda,
        EventBridge, Stepfunction, SNS, SQS, Dynamo DB etc. and I relish the
        opportunity to learn and adapt to new tools and technologies as they
        emerge.
      </li>
      <li>
        ...
        implementing data lakes and data marts, ensuring data is structured and
      ...
      <li>
        ...
        believe that great data engineering is built on effective communication
        and collaboration. I have experience working with data scientists,
        analysts, and business stakeholders to align technical solutions with
      ...
      <li>
        🚀 Always Ready for meeting with sharp & ambitious people to talk about
        different ideas to solve problems & make an impact
      </li>
    </ul>
    ...
    <h2>Project:</h2>
    <ol>
      <li>Food for Needy</li>
      <li>Talent Acquisition platform through community</li>
    </ol>
    <h2>Connect on</h2>
    <ul>
      <li>Telegram: navneet__s</li>
      <li>Twitter: navneet__s</li>
      <li>Linkedin</li>
      <li>Email: techmaaster007@gmail.com</li>
