const { sourceBridge, sender, updateSender } = props;

const { accountId } = context;

const isNear = sourceBridge === "near";

const isEth = sourceBridge == "eth";

const ethSender = sender;

const nearSender = accountId;

const isConnected = isEth ? !!ethSender : !!nearSender;
...
return (
  <Wrapper>
    {isConnected ? (
      ...
      <Web3Connect className="connect-button" connectLabel="Connect" />
    ) : (
