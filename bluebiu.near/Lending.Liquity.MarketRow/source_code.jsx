...
return (
  <StyledRow>
    ...
    >
      {columns.map((column) => (
        <StyledRowItem key={column.key} style={{ width: column.width }}>
          <Widget
            src="bluebiu.near/widget/Lending.Liquity.MarketCol"
            props={{
              key: column.key,
              data,
    ...
    {from === "YOURS" ? (
      <Widget
        src="bluebiu.near/widget/Lending.Liquity.PoolExpand"
        props={{
          expand: state.expand,
          ...props,
        }}
      ...
      <Widget
        src="bluebiu.near/widget/Lending.Liquity.MarketExpand"
        props={{
          expand: state.expand,
          ...props,
        }}
