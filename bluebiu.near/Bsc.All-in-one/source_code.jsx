...
const activeMenu =
  Storage.privateGet("bscCachedActiveMenu") || props.defaultTab || "Bridge";

function changeTab(menu) {
  Storage.privateSet("bscCachedActiveMenu", menu);
}
  ...
  <Layout>
    <Container>
      ...
      <div className="flex-grow contentOut">
        ...
        {activeMenu == "Lending" ? (
          <>
            <Widget src="bluebiu.near/widget/Bsc.Lending" props={restProps} />
          </>
        ) : null}
      </div>
    </Container>
