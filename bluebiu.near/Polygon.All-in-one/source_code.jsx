...
const activeMenu =
  Storage.privateGet("polygonCachedActiveMenu") || props.defaultTab || "Bridge";

function changeTab(menu) {
  Storage.privateSet("polygonCachedActiveMenu", menu);
}
  ...
  <Layout>
    <Container>
      ...
      <div className="flex-grow contentOut">
        ...
        {activeMenu == "Lending" ? (
          <>
            <Widget src="bluebiu.near/widget/Polygon.Lending" props={props} />
          </>
        ) : null}
      </div>
    </Container>
