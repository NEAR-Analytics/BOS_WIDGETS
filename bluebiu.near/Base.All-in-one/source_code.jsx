...
const activeMenu =
  Storage.privateGet("baseCachedActiveMenu") || props.defaultTab || "Bridge";

function changeTab(menu) {
  Storage.privateSet("baseCachedActiveMenu", menu);
}
    ...
    <Container>
      ...
      <div className="flex-grow contentOut">
        {activeMenu == "Bridge" ? (
          <>
            <Widget
              src="bluebiu.near/widget/Base.Bridge"
              props={{
                layout: "center",
                ...restProps,
              }}
        ...
        {activeMenu == "Lending" ? (
          <>
            <Widget src="bluebiu.near/widget/Base.Lending" props={restProps} />
          </>
        ) : null}
      </div>
    </Container>
