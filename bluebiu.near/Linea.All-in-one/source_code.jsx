...
const activeMenu =
  Storage.privateGet("lineaCachedActiveMenu") || props.defaultTab || "Bridge";

function changeTab(menu) {
  Storage.privateSet("lineaCachedActiveMenu", menu);
}
  ...
  <Layout>
    <Container>
      ...
      <div className="flex-grow contentOut">
        ...
        {activeMenu == "Lending" ? (
          <>
            <Widget src="bluebiu.near/widget/Linea.Lending" props={props} />
          </>
        ) : null}
      </div>
    </Container>
