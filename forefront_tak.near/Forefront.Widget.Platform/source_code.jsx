  ...
  <Container>
    <ul className="tabContent">
      <li className="tab-item">
        <button
          className={`${state.tab === Tab.tvl ? "active" : ""}`}
          aria-current="page"
          onClick={() => setTab(Tab.tvl)}
        >
          Tvl
        </button>
      </li>
      ...
      <li className="tab-item">
        <button
          className={`${state.tab === Tab.retention ? "active" : ""}`}
          aria-current="page"
          onClick={() => setTab(Tab.retention)}
        >
          Retention
        </button>
      </li>
...
const tvl = (
  <div className="w-100" style={{ display: state.tab === "tvl" ? "" : "none" }}>
    <Widget
      src="forefront_tak.near/widget/Forefront.Widget.Platform.Tvl"
      props={{
        themeColor,
      }}
    />
...
const leaderboard = (
  ...
  >
    <Widget
      src="forefront_tak.near/widget/Forefront.Widget.Platform.Leaderboard"
      props={{
        themeColor,
      }}
    />
...
const retention = (
  <div
    className="w-100"
    style={{ display: state.tab === "retention" ? "" : "none" }}
  >
    <Widget
      src="forefront_tak.near/widget/Forefront.Widget.Platform.Retention"
      props={{
        themeColor,
      }}
    />
