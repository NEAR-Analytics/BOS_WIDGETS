      ...
      {props.transactionHashes ? (
        ...
        <>
          ...
          <div class="card border-light">
            <div class="card-body">
              <p class="card-title fw-bold fs-6">Submit BOS HACKS Project</p>

              <p class="text-muted w-75 my-1">
                {state.postType === "Solution"
                  ? "Post your submission for BOS HACKS. Add a link to your component, github, and tag your team members. On a checklist indicate which bounties you are opt-in for."
                  : "Post your submission for BOS HACKS. Add a link to your component, github, and tag your team members. On a checklist indicate which bounties you are opt-in for."}
              </p>
              {state.warning && (
                <div
