...
function loadData() {
  ...
  asyncFetch(
    "https://storage.googleapis.com/databricks-near-query-runner/output/app-store-test-sorted.json"
  )
    .then((res) => {
      ...
      <Main>
        ...
        <Sections>
          {state.selectedTab === "Search" && (
            <Widget src="scopalaffairs.near/widget/AppLibrary.Search" />
          )}
                      ...
                      <Section key={section.title}>
                        ...
                        <ThumbnailGrid>
                          {section.items.map((item) => {
                            return (
                              <Widget
                                src="scopalaffairs.near/widget/AppLibrary.AppThumbnail"
                      ...
                      <Section key={section.title}>
                        ...
                        <ContentGrid>
                          {section.items.map((item) => {
                            return (
                              <Widget
                                src="scopalaffairs.near/widget/AppLibrary.AppCard"
                                key={item.author + item.widget_name}
                                props={{
                      ...
                      <Section key={section.title}>
                        ...
                        <ContentGrid>
                          {section.items.map((item) => {
                            return (
                              <Widget
                                src="scopalaffairs.near/widget/AppLibrary.ArticleSummary"
                                key={item.url}
                                props={{
                                  author: item.author,
                                  image: item.image,
