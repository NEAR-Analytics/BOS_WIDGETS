...
return (
  <Card>
    ...
    {props.follows_you !== null &&
      ...
      props.signer_id !== null &&
      props.similar_posts !== null && (
        <Scores>
          {props.follows_you == 1 && <Score>Follows You</Score>}
          <Score>
            {props.aggregated_authority_score.toString()} Auth Score
          </Score>
          <Score>{props.aggregated_hub_score.toString()} Hub Score</Score>
        </Scores>
      )}
