...
console.log("type categories", typeof state.categories);

function loadData() {
  if (state.categories.length > 0) return;

  asyncFetch(
    "https://storage.googleapis.com/databricks-near-query-runner/output/app-store-test4.json"
  )
    .then((res) => {
      ...
      State.update({
        ...
        isLoading: false,
        selectedTab: state.selectedTab ?? results.data[0].label,
      });
    })
    .catch((error) => {
      State.update({
