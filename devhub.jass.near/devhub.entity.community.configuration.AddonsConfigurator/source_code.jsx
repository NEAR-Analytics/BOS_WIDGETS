const { getAllAddons } =
  VM.require("devhub.jass.near/widget/core.adapter.devhub-contract") ||
  (() => {});
...
const AddonItem = ({
  ...
  return (
    <Row>
      ...
      <Cell>
        <Widget
          src="devhub.jass.near/widget/devhub.components.molecule.Input"
          props={{
            label: " ",
      ...
      <Cell>
        ...
        >
          <Widget
            src={"devhub.jass.near/widget/devhub.components.atom.Toggle"}
            props={{
              value: data.enabled,
      ...
      {isActive && availableAddons && list.length < 7 && (
        <div className="d-flex justify-content-center pt-2">
          <div className="d-flex gap-2 flex-grow-1 px-4">
            <Widget
              src={"devhub.jass.near/widget/devhub.components.molecule.Select"}
              props={{
