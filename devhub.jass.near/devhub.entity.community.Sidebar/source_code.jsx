...
const CommunitySummary = () => {
  return (
    <>
      <Widget
        src={"devhub.jass.near/widget/devhub.components.molecule.MarkdownViewer"}
        props={{
      ...
      <small class="text-muted mb-3">
        ...
        >
          <Widget
            src={"devhub.jass.near/widget/devhub.components.atom.Tag"}
...
return community === null ? (
  ...
  <div class="d-flex flex-column align-items-end">
    <Widget
      src={"devhub.jass.near/widget/devhub.entity.community.Tile"}
      props={{
        fullWidth: true,
        minHeight: 0,
        noBorder: true,
