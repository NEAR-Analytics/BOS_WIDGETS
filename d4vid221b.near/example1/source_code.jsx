...
return (
  <div class="p-3">
    <h3 class="text-primary bg-dark text-primary p-3 text-center">
      Libro de Visitas (BOS + NEAR)
    </h3>
    <br />
    {context.accountId ? (
      <div class="text-primary bg-dark text-primary p-3">
        <h3>Nuevo Mensaje</h3>
        <div class="row">
          <div>
            <input
    ...
    <div class="text-primary bg-dark text-primary p-3">
      ...
      <table className="table table-sm">
        <thead>
          <tr class="p-3 mb-2 bg-primary text-primary text-center">
            <th>Cuenta</th>
            <th>Mensaje</th>
          </tr>
        </thead>
