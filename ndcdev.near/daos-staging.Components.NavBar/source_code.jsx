const { assets } = VM.require(`ndcdev.near/widget/daos-staging.Config`);
const { hasNotifications } = props;

if (!assets) return <Widget src="flashui.near/widget/Loading" />;
const accountId = context.accountId;
const [admin, _widget, _name] = `ndcdev.near/widget/daos-staging.Config`.split("/");
const [showNav, setShowNav] = useState(false);
const items = [
  {
    name: "My Proposals",
    iconLeft: "ph ph-clipboard-text fs-6",
    href: `/ndcdev.near/widget/daos-staging.App?page=proposals&accountId=${context.accountId}`,
  },
  {
    name: "My Reports",
    iconLeft: "ph ph-presentation-chart fs-6",
    href: `/ndcdev.near/widget/daos-staging.App?page=reports&accountId=${context.accountId}`,
  },
  {
    name: "Settings",
    iconLeft: "ph ph-gear-six fs-6",
    href: `/ndcdev.near/widget/daos-staging.App?page=settings`,
  },
];
  ...
  <Container>
    <Navbar className="container-xl">
      <a
        ...
        href={`/ndcdev.near/widget/daos-staging.App`}
      >
