...
<html>
  <head>
    ...
    .container.show {
      ...
      background: #FFF;
      box-shadow: 0px 68px 19px 0px rgba(0, 0, 0, 0.00), 0px 43px 17px 0px rgba(0, 0, 0, 0.01), 0px 24px 15px 0px rgba(0, 0, 0, 0.04), 0px 11px 11px 0px rgba(0, 0, 0, 0.07), 0px 3px 6px 0px rgba(0, 0, 0, 0.08);
    }
    </style>
  </head>
  ...
  <script>
    ...
    sheet.replaceSync(".container.show { box-shadow: none; }")
    document.shadowRoot.adoptedStyleSheets.push(sheet)
  </script>
</html>
`;
