          ...
          items: [
            {
              ...
              content: (
                <Widget
                  src="ndcdev.near/widget/daos-staging.Components.Settings.General"
                  props={{ selectedDao }}
                />
              ),
              icon: "ph ph-gear",
            },
            {
              ...
              content: (
                <Widget
                  src="ndcdev.near/widget/daos-staging.Components.Settings.Members"
                  props={{ selectedDao }}
                />
              ),
              icon: "ph ph-users",
            },
            {
              ...
              content: (
                <Widget
                  src="ndcdev.near/widget/daos-staging.Components.Settings.Communities"
                  props={{ selectedDao }}
                />
              ),
            ...
            },
            {
              ...
              content: (
                <Widget
                  src="ndcdev.near/widget/daos-staging.Components.Settings.Contacts"
                  props={{ selectedDao }}
                />
              ),
              icon: "ph ph-link",
            },
            {
              ...
              content: (
                <Widget
                  src="ndcdev.near/widget/daos-staging.Components.Settings.Content"
                  props={{ selectedDao }}
                />
              ),
