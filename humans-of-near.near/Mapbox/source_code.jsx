...
<html>
  ...
  <body>
    ...
    function getDetail (row) {
       var title = "";
       const state = row.user.accountId.indexOf(".near");
       if(row.user.name){
        title = row.user.name;
       } else if(state !== -1){
        title = row.user.accountId;
       } else {
