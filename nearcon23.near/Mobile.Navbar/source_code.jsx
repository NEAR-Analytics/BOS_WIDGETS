...
const Button = styled.button`
    ...
    border: none;
     ...
     color: ${(p) => (p?.selected ? "#FFFFFF" : "#00EC97")};
...
return (
  <Container>
    ...
    <Link to="/mobile">
      <Button
        selected={selectedButton === "alerts"}
        onClick={() => setSelectedButton("alerts")}
      >
        <Icon>
          {selectedButton === "alerts" ? (
            <Widget src={`${ownerId}/widget/Icons.SelectedAlerts`} />
          ) : (
            <svg
              width="33"
              height="32"
      ...
      >
        <Icon>
          {selectedButton === "map" ? (
            ...
            >
              <path
                d="M29.115 6.21125C28.9952 6.11791 28.8557 6.05308 28.7072 6.02168C28.5586 5.99027 28.4048 5.99312 28.2575 6.03L20.6162 7.94L12.9475 4.105C12.7338 3.99842 12.4891 3.97182 12.2575 4.03L4.2575 6.03C4.04116 6.08408 3.8491 6.20891 3.71185 6.38467C3.5746 6.56042 3.50003 6.777 3.5 7V25C3.50002 25.152 3.53467 25.3019 3.60132 25.4385C3.66797 25.575 3.76486 25.6946 3.88463 25.7881C4.00441 25.8816 4.14392 25.9466 4.29256 25.9781C4.44121 26.0096 4.59508 26.0068 4.7425 25.97L12.3837 24.06L20.0525 27.895C20.1917 27.9636 20.3448 27.9995 20.5 28C20.5818 28 20.6632 27.9899 20.7425 27.97L28.7425 25.97C28.9588 25.9159 29.1509 25.7911 29.2881 25.6153C29.4254 25.4396 29.5 25.223 29.5 25V7C29.5 6.84791 29.4654 6.69781 29.3987 6.56113C29.3319 6.42445 29.2349 6.30479 29.115 6.21125ZM13.5 6.6175L19.5 9.6175V25.3825L13.5 22.3825V6.6175ZM5.5 7.78125L11.5 6.28125V22.2188L5.5 23.7188V7.78125ZM27.5 24.2188L21.5 25.7188V9.78125L27.5 8.28125V24.2188Z"
                fill="currentColor"
              />
            </svg>
          )}
    ...
    <Link to="/mobile">
      <Button
        selected={selectedButton === "schedule"}
        onClick={() => setSelectedButton("schedule")}
      >
        <Icon>
          {selectedButton === "schedule" ? (
            <Widget src={`${ownerId}/widget/Icons.SelectedSchedule`} />
          ) : (
            <svg
              width="33"
              height="32"
    ...
    <Link to="/mobile">
      <Button
        ...
        onClick={() => setSelectedButton("help")}
      >
        <Icon>
          {selectedButton === "help" ? (
            <Widget src={`${ownerId}/widget/Icons.SelectedHelp`} />
          ) : (
            <svg
              width="24"
              height="24"
