...
const accountId = loggedIn
  ? context.accountId ?? "nearbrasil.near"
  : props.accountId ?? "nearbrasil.near";
...
const profile1 = {
  ...
  links: [{ title: "twitter", url: "https://twitter.com/nearprotocolbr" }],
  socials: [
    { title: "github", url: "https://github.com/zahid-dev" },
    { title: "twitter", url: "https://twitter.com/nearprotocolbr" },
  ],
};
