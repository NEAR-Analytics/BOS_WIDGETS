...
const contracts = props.contracts ||
  context.contracts || [
    "humansof.near",
    "menaidao.mintbase1.near",
    "abstractphotography.mintbase1.near",
    "strato.mintbase1.near",
    "humansofbrazil.sharddog.near",
    "nadastudiocriativo.mintbase1.near",
    "techne.mintbase1.near",
    "brasilidades.mintbase1.near",
  ];
...
return data !== null ? (
  <MainContainer>
    <Header>
      <h2 style={{ fontWeight: 600 }}>Projetos NFT brasileiros em Near </h2>
      <p>
        Essa página é dedicada a todos os projetos e artes criados em Near.
        Conheça e crie também! Estamos em construção
      </p>
    </Header>
