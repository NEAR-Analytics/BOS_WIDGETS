/**
 * Imports and uses near-wallet-selector within an iframe
 *
 * (not working)
 *
 * Credit: https://github.com/petersalomonsen/near-bos-webcomponent/blob/main/public/index.html
 */
  ...
  <script type="module">
      ...
      async function init() {
        const selector = await setupWalletSelector({
          network: "mainnet",
          modules: [setupMyNearWallet(), setupHereWallet(), setupSender()],
        });
...
return <iframe srcDoc={srcDoc} height={500} width={500} />;
