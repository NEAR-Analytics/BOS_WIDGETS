...
const nep141TotalSupply = isDigit(state.nep141TotalSupply)
  ...
  : "-";
const nrc20TotalSupply = isDigit(state.nrc20TotalSupply)
  ? formatAmount(state.nrc20TotalSupply)
  : "-";

const TokenRegistrationWrapper = styled("Link")`
  color: white;
  cursor: pointer;
  font-size: 16px;
  font-weight: 600;
...
return (
  <>
    <NRC20Header style={{ justifyContent: "flex-start" }}>
      {props.register !== "true" && (
        <TokenRegistrationWrapper
          href={`/${config.ownerId}/widget/NRC-20?tab=wrap&register=true${
            props.tick ? `&tick=${props.tick}` : ""
          }`}
        >
          Register NEP-141 Wrapper Token
        </TokenRegistrationWrapper>
      )}
      {props.register === "true" && (
        <TokenRegistrationWrapper
    ...
    {props.register !== "true" && (
      <FormContainer>
        ...
        {state.wrapTab === "wrap" && (
          <Widget
            src={`${config.ownerId}/widget/NRC-20.Wrap`}
            props={{
              tick: props.tick,
            }}
          />
        ...
        {state.wrapTab === "unwrap" && (
          <Widget
            src={`${config.ownerId}/widget/NRC-20.Unwrap`}
            props={{
              tick: props.tick,
            }}
          />
    ...
    {props.register === "true" && (
      <FormContainer>
        <Widget
          src={`${config.ownerId}/widget/NRC-20.TokenRegistration`}
          props={{
            tick: props.tick,
          }}
        />
