...
} = VM.require("espen.near/widget/core.adapter.devhub-contract");
...
return (
  <>
    <Widget
      src="espen.near/widget/devhub.components.atom.Alert"
      props={{
    ...
    <Tile className="p-3 mb-3">
      ...
      <Widget
        src="espen.near/widget/devhub.components.molecule.ListEditor"
        props={{
          data: {
            maxLength: 5,
    ...
    <Widget
      src={"espen.near/widget/devhub.components.molecule.PostControls"}
      props={{
    ...
    <div class="mt-3">
      {previewConnect && (
        <Widget
          src="espen.near/widget/devhub.components.island.connect"
          props={{ ...props }}
        />
      )}
    </div>
