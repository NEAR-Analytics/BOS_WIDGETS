const { Card } =
  VM.require("espen.near/widget/devhub.entity.addon.blog.Card") ||
  (() => <></>);
const { Page } =
  VM.require("espen.near/widget/devhub.entity.addon.blog.Page") ||
  (() => <></>);
...
return (
  <Container>
    ...
    <div className="tab-content" id="editPreviewTabsContent">
      ...
      >
        <Widget
          src="espen.near/widget/devhub.entity.addon.blog.editor.form"
          props={{
            title,
            setTitle,
            subtitle,
      ...
      >
        <div style={{ position: "absolute", top: 10, right: 0 }}>
          <Widget
            src="espen.near/widget/devhub.components.molecule.Switch"
            props={{
