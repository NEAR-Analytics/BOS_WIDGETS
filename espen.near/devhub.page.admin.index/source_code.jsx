...
function createEditTeam({
  ...
  members.forEach((member) => {
    ...
    if (!membersAndTeams.includes(member)) {
      // Add member
      txn.push({
        contractName: "devgovgigs.espen.near",
  ...
  <Container>
    <div className="d-flex flex-column gap-4 p-4">
      ...
      <div class="tab-content" id="myTabContent">
        ...
        >
          <Widget src="espen.near/widget/devhub.page.admin.homepageTab" />
        </div>
        <div
          class="tab-pane fade"
          id="profile"
        ...
        >
          <Widget
            src="espen.near/widget/devhub.page.admin.moderatorsTab"
            props={{
              accessControlInfo,
              createEditTeam,
            }}
        ...
        >
          <Widget
            src="espen.near/widget/devhub.page.admin.restrictedLabelsTab"
            props={{
              accessControlInfo,
              createEditTeam,
              teamNames,
