    ...
    <div className="tab-content" id="editPreviewTabsContent">
      ...
      >
        ...
        <FormContainer>
          <div className="flex-grow-1">
            <Widget
              src="espen.near/widget/devhub.components.molecule.Input"
              props={{
                label: "Title",
          ...
          <Widget
            src="espen.near/widget/devhub.components.molecule.MarkdownEditor"
      ...
      >
        <div className="w-100 h-100 p-4">
          <Widget
            src="espen.near/widget/devhub.entity.addon.wiki.Viewer"
