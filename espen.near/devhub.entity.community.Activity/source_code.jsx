  ...
  <div style={{ maxWidth: "100%", width: "100%" }}>
    <div class="col">
      <div class="d-flex w-100">
        <MainContent>
          <Widget
            src={"espen.near/widget/devhub.feature.post-search.panel"}
            props={{
              hideHeader: true,
              ...
              children: (
                <Widget
                  src={
                    "espen.near/widget/devhub.components.molecule.PostControls"
                  }
                  props={{
                    title: "Post",
                    href: href({
        ...
        <SidebarContainer>
          <Widget
            src={"espen.near/widget/devhub.entity.community.Sidebar"}
