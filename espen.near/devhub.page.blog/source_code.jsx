...
if (id) {
  return (
    <Widget
      src="espen.near/widget/devhub.entity.post.Postv2"
...
return (
  <div className="w-100">
    <Widget src={`espen.near/widget/devhub.components.island.banner`} />
    <HeaderContainer>
      <Header>Blog</Header>
    </HeaderContainer>
    <BlogContainer>
      <Widget
        src={"espen.near/widget/devhub.entity.addon.blog.Viewer"}
        props={{
