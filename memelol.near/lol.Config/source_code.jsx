return {
  ...
  assets: {
    ...
    instructions: [
      "https://ipfs.near.social/ipfs/bafkreih2uttjgswm3w3lagx5k4whcr3mkbccaswct7skfti24emsidg6fe",
      "https://ipfs.near.social/ipfs/bafkreiefj5koaplezhcykn6mbcgeqdfn72gdcaq7kquoul7m5pcsph2tk4",
      "https://ipfs.near.social/ipfs/bafkreihwjg5nzfb6wi5445qse424d6p37ogapaw3coigm4p772ihytey6a",
    ],
  },
  content: {
    shareLink:
    ...
    FAQ: {
      box: [
        {
          question: "How to win $LOL and $NEAR?",
          answer: (
            <div className={"mt-3 mb-4"}>
              ...
              <p>
                ...
                participate by opening boxes for 0.075 NEAR each, receiving
                random amounts of LOL tokens, and having the chance to win from
                a pool of 5551 premium boxes. These premium boxes contain
                different amounts of NEAR tokens, ranging from 0.1 NEAR to a
                jackpot of 1000 NEAR. This means that for just 0.075 NEAR, you
        ...
        },
        {
          ...
          answer: (
            <div className={"mt-3 mb-4"}>
              <p>
                People participating in token distribution openning a boxes.
                Each box give you random amount of LOL tokens, and a chance to
                win NEAR tokens from premium boxes. There are five distinct box
                types, each offering varied rewards randomly drawn upon box
                opening:
              </p>

              <ul>
                <li>
                  <b>Regular Box:</b> Contains 1000 - 10000 LOL tokens.
                  Quantity: <b>44,449</b> boxes;
                </li>
                <li>
              ...
              <p>
                Upon opening a box, users instantly receive rewards in LOL
                and/or NEAR tokens, credited to their account.
              </p>
            </div>
          ),
        },
      ...
      puzzle: [
        {
          ...
          answer: (
            <div className={"mt-3 mb-4"}>
              <p>
                People can use their <b>$LOL</b> tokens to complete a puzzle.
                Each puzzle will have rewards.
              </p>
            </div>
          ),
        },
        {
          question: "How Premium users use their advantage?",
          answer: (
            <div className={"mt-3 mb-4"}>
              <p></p>
            </div>
