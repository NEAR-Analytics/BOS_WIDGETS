return (
  <>
    {context.accountId && (
      <Widget src="andyh.near/widget/ProfileOnboarding" isTrusted={false} />
    )}
    <Widget
    ...
    <div className="row mb-3">
      <Widget src="andyh.near/widget/People" isTrusted={false} />
    </div>
    <div className="row mb-3">
      <div>
        <h4>Get involved</h4>
    ...
    <div className="row mb-3">
      <div className="col-md-8">
        ...
        <Widget src="andyh.near/widget/FollowFeed" isTrusted={false} />
      </div>
